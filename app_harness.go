...
func newHarness(app *App, paths harnessPaths) *Harness {
	return &Harness{app: app, paths: paths, pageMarker: newHarnessPageMarker()}
}

func (h *Harness) harnessPageMarker() string { return h.pageMarker }
...
func (h *Harness) HarnessInfo() (HarnessInfoResult, error) {
	...
	return HarnessInfoResult{
		...
		AssetsDigest:       h.paths.AssetsDigest,

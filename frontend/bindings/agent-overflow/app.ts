...
const $$createType56 = provider$0.ModelInfo.createFrom;
...
const $$createType65 = app$0.PayloadPreview.createFrom;
const $$createType66 = app$0.WorktreeSetupConfig.createFrom;
const $$createType67 = provider$0.ProviderStatus.createFrom;
const $$createType68 = $Create.Array($$createType67);
const $$createType69 = app$0.PushSenderStatus.createFrom;
const $$createType70 = flushqueue$0.QueuedItem.createFrom;
const $$createType71 = $Create.Array($$createType70);
const $$createType72 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType73 = $Create.Array($$createType72);
const $$createType74 = sshsetup$0.Status.createFrom;
const $$createType75 = app$0.ServiceUpdateStatus.createFrom;
const $$createType76 = soundlib$0.Files.createFrom;
const $$createType77 = spinner$0.Files.createFrom;
const $$createType78 = app$0.TerminalReplay.createFrom;
const $$createType79 = theme$0.Files.createFrom;
const $$createType80 = app$0.ThreadContextUsage.createFrom;
const $$createType81 = app$0.ThreadDefaults.createFrom;
const $$createType82 = store$0.Item.createFrom;
const $$createType83 = app$0.ItemProjectionSource.createFrom;
const $$createType84 = app$0.ThreadLiveState.createFrom;
const $$createType85 = $Create.Array($$createType10);
const $$createType86 = store$0.TurnPreview.createFrom;
const $$createType87 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType88 = $Create.Array($$createType87);
const $$createType89 = store$0.UserMessageTick.createFrom;
const $$createType90 = $Create.Array($$createType89);
const $$createType91 = app$0.WorktreeSetupRunState.createFrom;
const $$createType92 = app$0.TurnEditsDiff.createFrom;
const $$createType93 = $Create.Map($Create.Any, $Create.Any);
const $$createType94 = store$0.UsageBucket.createFrom;
const $$createType95 = $Create.Array($$createType94);
const $$createType96 = app$0.WorkspaceActivity.createFrom;
const $$createType97 = app$0.GitWorkspaceState.createFrom;
const $$createType98 = git$0.GitActionResult.createFrom;
const $$createType99 = app$0.BranchPruneCandidates.createFrom;
const $$createType100 = git$0.GitBranch.createFrom;
const $$createType101 = $Create.Array($$createType100);
const $$createType102 = app$0.WorktreeListItem.createFrom;
const $$createType103 = $Create.Array($$createType102);
const $$createType104 = app$0.BranchPruneResult.createFrom;
const $$createType105 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType106 = app$0.WorktreeStatus.createFrom;
const $$createType107 = $Create.Array($Create.Any);
const $$createType108 = highlightapp$0.Result.createFrom;
const $$createType109 = app$0.ImportRunHandle.createFrom;
const $$createType110 = app$0.ImportUpdateResult.createFrom;
const $$createType111 = app$0.InterruptAndRevertResult.createFrom;
...
const $$createType127 = $Create.Array($$createType82);

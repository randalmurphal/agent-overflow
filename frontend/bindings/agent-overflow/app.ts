...
const $$createType14 = app$0.ProjectDeletionResult.createFrom;
const $$createType15 = settings$0.Settings.createFrom;
const $$createType16 = app$0.PairingStatusView.createFrom;
const $$createType17 = app$0.PasskeySummary.createFrom;
const $$createType18 = app$0.PasskeyStepUpGrant.createFrom;
const $$createType19 = network$0.Settings.createFrom;
const $$createType20 = app$0.GeneratedCommitMessage.createFrom;
const $$createType21 = app$0.AccessOverview.createFrom;
const $$createType22 = app$0.AttachmentThumbnail.createFrom;
const $$createType23 = store$0.ChannelMessage.createFrom;
const $$createType24 = $Create.Array($$createType23);
const $$createType25 = claudeconfig$0.Skill.createFrom;
const $$createType26 = $Create.Array($$createType25);
const $$createType27 = app$0.ClaudeSlashCommands.createFrom;
const $$createType28 = app$0.CodexAccountUsage.createFrom;
const $$createType29 = $Create.Nullable($$createType28);
const $$createType30 = codexskills$0.CwdSkills.createFrom;
const $$createType31 = app$0.ContextSettingsProfile.createFrom;
const $$createType32 = devscan$0.DevServerList.createFrom;
const $$createType33 = app$0.DiffContextResult.createFrom;
const $$createType34 = store$0.DiscussionDefinition.createFrom;
const $$createType35 = app$0.Draft.createFrom;
const $$createType36 = settings$0.EditorSettings.createFrom;
const $$createType37 = git$0.GitStatus.createFrom;
const $$createType38 = keybindings$0.LoadResult.createFrom;
const $$createType39 = app$0.LocalImageData.createFrom;
const $$createType40 = mcpstatus$0.ServerStatus.createFrom;
const $$createType41 = provider$0.ModelInfo.createFrom;
const $$createType42 = $Create.Array($$createType41);
const $$createType43 = app$0.PRCIJobLogResult.createFrom;
const $$createType44 = git$0.CIPipeline.createFrom;
const $$createType45 = git$0.PRDetail.createFrom;
const $$createType46 = app$0.PRMergeConflictsResult.createFrom;
const $$createType47 = app$0.PayloadChunk.createFrom;
const $$createType48 = app$0.PayloadContent.createFrom;
const $$createType49 = app$0.PayloadPreview.createFrom;
const $$createType50 = app$0.WorktreeSetupConfig.createFrom;
const $$createType51 = provider$0.ProviderStatus.createFrom;
const $$createType52 = $Create.Array($$createType51);
const $$createType53 = app$0.PushSenderStatus.createFrom;
const $$createType54 = flushqueue$0.QueuedItem.createFrom;
const $$createType55 = $Create.Array($$createType54);
const $$createType56 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType57 = $Create.Array($$createType56);
const $$createType58 = app$0.ServiceUpdateStatus.createFrom;
const $$createType59 = spinner$0.Files.createFrom;
const $$createType60 = app$0.TerminalReplay.createFrom;
const $$createType61 = theme$0.Files.createFrom;
const $$createType62 = app$0.ThreadContextUsage.createFrom;
const $$createType63 = app$0.ThreadDefaults.createFrom;
const $$createType64 = store$0.Item.createFrom;
const $$createType65 = app$0.ItemProjectionSource.createFrom;
const $$createType66 = app$0.ThreadLiveState.createFrom;
const $$createType67 = store$0.TurnPreview.createFrom;
const $$createType68 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType69 = $Create.Array($$createType68);
const $$createType70 = store$0.UserMessageTick.createFrom;
const $$createType71 = $Create.Array($$createType70);
const $$createType72 = app$0.WorktreeSetupRunState.createFrom;
const $$createType73 = app$0.TurnEditsDiff.createFrom;
const $$createType74 = $Create.Map($Create.Any, $Create.Any);
const $$createType75 = store$0.UsageBucket.createFrom;
const $$createType76 = $Create.Array($$createType75);
const $$createType77 = app$0.WorkspaceActivity.createFrom;
const $$createType78 = app$0.GitWorkspaceState.createFrom;
const $$createType79 = git$0.GitActionResult.createFrom;
const $$createType80 = app$0.BranchPruneCandidates.createFrom;
const $$createType81 = git$0.GitBranch.createFrom;
const $$createType82 = $Create.Array($$createType81);
const $$createType83 = app$0.WorktreeListItem.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = app$0.BranchPruneResult.createFrom;
const $$createType86 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType87 = app$0.WorktreeStatus.createFrom;
const $$createType88 = $Create.Array($Create.Any);
const $$createType89 = app$0.HighlightResult.createFrom;
const $$createType90 = app$0.ImportRunHandle.createFrom;
const $$createType91 = app$0.ImportUpdateResult.createFrom;
const $$createType92 = app$0.InterruptAndRevertResult.createFrom;
const $$createType93 = $Create.Array($$createType2);
const $$createType94 = store$0.Attachment.createFrom;
const $$createType95 = $Create.Array($$createType94);
const $$createType96 = app$0.EditorInfo.createFrom;
const $$createType97 = $Create.Array($$createType96);
const $$createType98 = attachedbackends$0.Attached.createFrom;
const $$createType99 = $Create.Array($$createType98);
const $$createType100 = gitdiff$0.Commit.createFrom;
const $$createType101 = $Create.Array($$createType100);
const $$createType102 = store$0.ChatBarFavorite.createFrom;
const $$createType103 = $Create.Array($$createType102);
const $$createType104 = $Create.Array($$createType11);
const $$createType105 = $Create.Array($$createType34);
const $$createType106 = app$0.ImportScanResult.createFrom;
const $$createType107 = $Create.Array($$createType64);
const $$createType108 = store$0.PagedItems.createFrom;
const $$createType109 = $Create.Array($$createType40);
const $$createType110 = git$0.ReviewThread.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = $Create.Array($$createType17);
const $$createType113 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType114 = store$0.ProjectWithCounts.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = $Create.Array($$createType13);
const $$createType117 = app$0.ManagedProviderAccount.createFrom;
const $$createType118 = $Create.Array($$createType117);
const $$createType119 = store$0.Turn.createFrom;
const $$createType120 = $Create.Array($$createType119);
const $$createType121 = app$0.ReleaseSummary.createFrom;
const $$createType122 = $Create.Array($$createType121);
const $$createType123 = app$0.BackgroundWorkInventory.createFrom;
const $$createType124 = terminal$0.SessionSummary.createFrom;
const $$createType125 = $Create.Array($$createType124);
const $$createType126 = app$0.EditDiffList.createFrom;
const $$createType127 = app$0.ThreadMCPServer.createFrom;
const $$createType128 = $Create.Array($$createType127);
const $$createType129 = wsllauncher$0.Distro.createFrom;
const $$createType130 = $Create.Array($$createType129);
const $$createType131 = app$0.PairingInvite.createFrom;
const $$createType132 = app$0.TerminalHandle.createFrom;
const $$createType133 = provider$0.AccountInfo.createFrom;
const $$createType134 = app$0.ProjectDeletionPreview.createFrom;
const $$createType135 = app$0.ProviderTerminalHandle.createFrom;
const $$createType136 = app$0.DeviceRevocationResult.createFrom;
const $$createType137 = store$0.ThreadMessageHit.createFrom;
const $$createType138 = $Create.Array($$createType137);
const $$createType139 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType140 = app$0.CodexReviewStarted.createFrom;
const $$createType141 = app$0.SubmitPRReviewResult.createFrom;
const $$createType142 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType143 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType144 = app$0.MCPAuthInitResult.createFrom;
const $$createType145 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType146 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType147 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType148 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType149 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType150 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType151 = app$0.WorkflowAgentRunView.createFrom;
const $$createType152 = $Create.Array($$createType151);
const $$createType153 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType154 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType155 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType156 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType157 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType158 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType159 = store$0.WorkItem.createFrom;
const $$createType160 = app$0.WorkflowAutomationView.createFrom;
const $$createType161 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType162 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType163 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType164 = engine$0.EngineState.createFrom;
const $$createType165 = app$0.WorkflowItemDetailView.createFrom;
const $$createType166 = app$0.WorkflowRunMapView.createFrom;
const $$createType167 = $Create.Array($$createType160);
const $$createType168 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType169 = $Create.Map($Create.Any, $Create.Any);
const $$createType170 = $Create.Array($$createType159);

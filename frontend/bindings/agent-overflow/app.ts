...
const $$createType53 = store$0.TurnPreview.createFrom;
const $$createType54 = store$0.UserMessageTick.createFrom;
const $$createType55 = $Create.Array($$createType54);
const $$createType56 = $models.WorktreeSetupRunState.createFrom;
const $$createType57 = $models.TurnEditsDiff.createFrom;
const $$createType58 = $Create.Map($Create.Any, $Create.Any);
const $$createType59 = store$0.UsageBucket.createFrom;
const $$createType60 = $Create.Array($$createType59);
const $$createType61 = $models.WorkspaceActivity.createFrom;
const $$createType62 = $models.GitWorkspaceState.createFrom;
const $$createType63 = git$0.GitActionResult.createFrom;
const $$createType64 = $models.BranchPruneCandidates.createFrom;
const $$createType65 = git$0.GitBranch.createFrom;
const $$createType66 = $Create.Array($$createType65);
const $$createType67 = $models.WorktreeListItem.createFrom;
const $$createType68 = $Create.Array($$createType67);
const $$createType69 = $models.BranchPruneResult.createFrom;
const $$createType70 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType71 = $models.WorktreeStatus.createFrom;
const $$createType72 = $Create.Array($Create.Any);
const $$createType73 = $models.HighlightResult.createFrom;
const $$createType74 = $models.ImportRunHandle.createFrom;
const $$createType75 = $models.ImportUpdateResult.createFrom;
const $$createType76 = $models.InterruptAndRevertResult.createFrom;
const $$createType77 = $models.DesignOptionSet.createFrom;
const $$createType78 = $Create.Nullable($$createType77);
const $$createType79 = $Create.Array($$createType1);
const $$createType80 = store$0.Attachment.createFrom;
const $$createType81 = $Create.Array($$createType80);
const $$createType82 = $models.EditorInfo.createFrom;
const $$createType83 = $Create.Array($$createType82);
const $$createType84 = gitdiff$0.Commit.createFrom;
const $$createType85 = $Create.Array($$createType84);
const $$createType86 = store$0.ChatBarFavorite.createFrom;
const $$createType87 = $Create.Array($$createType86);
const $$createType88 = $Create.Array($$createType6);
const $$createType89 = $Create.Array($$createType24);
const $$createType90 = $models.ImportScanResult.createFrom;
const $$createType91 = $Create.Array($$createType51);
const $$createType92 = store$0.PagedItems.createFrom;
const $$createType93 = $Create.Array($$createType29);
const $$createType94 = git$0.ReviewThread.createFrom;
const $$createType95 = $Create.Array($$createType94);
const $$createType96 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType97 = store$0.ProjectWithCounts.createFrom;
const $$createType98 = $Create.Array($$createType97);
const $$createType99 = $Create.Array($$createType8);
const $$createType100 = $models.ManagedProviderAccount.createFrom;
const $$createType101 = $Create.Array($$createType100);
const $$createType102 = store$0.Turn.createFrom;
const $$createType103 = $Create.Array($$createType102);
const $$createType104 = $models.ReleaseSummary.createFrom;
const $$createType105 = $Create.Array($$createType104);
const $$createType106 = $Create.Array($$createType0);
const $$createType107 = terminal$0.SessionSummary.createFrom;
const $$createType108 = $Create.Array($$createType107);
const $$createType109 = $models.EditDiffList.createFrom;
const $$createType110 = $models.ThreadMCPServer.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = wsllauncher$0.Distro.createFrom;
const $$createType113 = $Create.Array($$createType112);
const $$createType114 = $models.TerminalHandle.createFrom;
const $$createType115 = provider$0.AccountInfo.createFrom;
const $$createType116 = $models.ProjectDeletionPreview.createFrom;
const $$createType117 = $models.ProviderTerminalHandle.createFrom;
const $$createType118 = store$0.ThreadMessageHit.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType121 = $models.CodexReviewStarted.createFrom;
const $$createType122 = $models.SubmitPRReviewResult.createFrom;
const $$createType123 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType124 = $models.SyncThreadWindowResponse.createFrom;
const $$createType125 = $models.MCPAuthInitResult.createFrom;
const $$createType126 = $models.VerifyEditDiffsResult.createFrom;
const $$createType127 = $models.WorkflowAgentMemoryResult.createFrom;
const $$createType128 = $models.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType129 = $models.WorkflowAgentGuideRunResult.createFrom;
const $$createType130 = $models.WorkflowAgentRunInspection.createFrom;
const $$createType131 = $models.WorkflowAgentMemoryLog.createFrom;
const $$createType132 = $models.WorkflowAgentRunView.createFrom;
const $$createType133 = $Create.Array($$createType132);
const $$createType134 = $models.WorkflowAgentNarrative.createFrom;
const $$createType135 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType136 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType137 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType138 = $models.WorkflowAgentStartResult.createFrom;
const $$createType139 = $models.WorkflowAgentWatchResult.createFrom;
const $$createType140 = store$0.WorkItem.createFrom;
const $$createType141 = $models.WorkflowAutomationView.createFrom;
const $$createType142 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType143 = $models.WorkflowDiscardPreview.createFrom;
const $$createType144 = $models.WorkflowPRReviewComments.createFrom;
const $$createType145 = engine$0.EngineState.createFrom;
const $$createType146 = $models.WorkflowItemDetailView.createFrom;
const $$createType147 = $models.WorkflowRunMapView.createFrom;
const $$createType148 = $Create.Array($$createType141);
const $$createType149 = $models.WorkflowDefinitionCatalog.createFrom;
const $$createType150 = $Create.Map($Create.Any, $Create.Any);
const $$createType151 = $Create.Array($$createType140);

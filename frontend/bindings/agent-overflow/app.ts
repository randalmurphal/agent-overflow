...
const $$createType4 = $models.ImportUpdateStatus.createFrom;
const $$createType5 = $models.ChannelStatePayload.createFrom;
const $$createType6 = store$0.DiffReviewComment.createFrom;
const $$createType7 = store$0.Project.createFrom;
const $$createType8 = store$0.ProposedPlanComment.createFrom;
const $$createType9 = $models.ProjectDeletionResult.createFrom;
const $$createType10 = settings$0.Settings.createFrom;
const $$createType11 = $models.GeneratedCommitMessage.createFrom;
const $$createType12 = $models.AttachmentThumbnail.createFrom;
const $$createType13 = store$0.ChannelMessage.createFrom;
const $$createType14 = $Create.Array($$createType13);
const $$createType15 = claudeconfig$0.Skill.createFrom;
const $$createType16 = $Create.Array($$createType15);
const $$createType17 = $models.ClaudeSlashCommands.createFrom;
const $$createType18 = $models.CodexAccountUsage.createFrom;
const $$createType19 = $Create.Nullable($$createType18);
const $$createType20 = codexskills$0.CwdSkills.createFrom;
const $$createType21 = $models.ContextSettingsProfile.createFrom;
const $$createType22 = $models.DesignWorkdirInfo.createFrom;
const $$createType23 = $models.DiffContextResult.createFrom;
const $$createType24 = store$0.DiscussionDefinition.createFrom;
const $$createType25 = $models.Draft.createFrom;
const $$createType26 = settings$0.EditorSettings.createFrom;
const $$createType27 = git$0.GitStatus.createFrom;
const $$createType28 = keybindings$0.LoadResult.createFrom;
const $$createType29 = mcpstatus$0.ServerStatus.createFrom;
const $$createType30 = provider$0.ModelInfo.createFrom;
const $$createType31 = $Create.Array($$createType30);
const $$createType32 = network$0.Settings.createFrom;
const $$createType33 = $models.PRCIJobLogResult.createFrom;
const $$createType34 = git$0.CIPipeline.createFrom;
const $$createType35 = git$0.PRDetail.createFrom;
const $$createType36 = $models.PRMergeConflictsResult.createFrom;
const $$createType37 = $models.PayloadChunk.createFrom;
const $$createType38 = $models.PayloadContent.createFrom;
const $$createType39 = $models.PayloadPreview.createFrom;
const $$createType40 = $models.WorktreeSetupConfig.createFrom;
const $$createType41 = provider$0.ProviderStatus.createFrom;
const $$createType42 = $Create.Array($$createType41);
const $$createType43 = flushqueue$0.QueuedItem.createFrom;
const $$createType44 = $Create.Array($$createType43);
const $$createType45 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType46 = $Create.Array($$createType45);
const $$createType47 = $models.TerminalReplay.createFrom;
const $$createType48 = theme$0.Files.createFrom;
const $$createType49 = $models.ThreadContextUsage.createFrom;
const $$createType50 = $models.ThreadDefaults.createFrom;
const $$createType51 = store$0.Item.createFrom;
const $$createType52 = $models.ThreadLiveState.createFrom;
const $$createType53 = $models.WorktreeSetupRunState.createFrom;
const $$createType54 = $models.TurnEditsDiff.createFrom;
const $$createType55 = $Create.Map($Create.Any, $Create.Any);
const $$createType56 = store$0.UsageBucket.createFrom;
const $$createType57 = $Create.Array($$createType56);
const $$createType58 = $models.WorkspaceActivity.createFrom;
const $$createType59 = $models.GitWorkspaceState.createFrom;
const $$createType60 = git$0.GitActionResult.createFrom;
const $$createType61 = $models.BranchPruneCandidates.createFrom;
const $$createType62 = git$0.GitBranch.createFrom;
const $$createType63 = $Create.Array($$createType62);
const $$createType64 = $models.WorktreeListItem.createFrom;
const $$createType65 = $Create.Array($$createType64);
const $$createType66 = $models.BranchPruneResult.createFrom;
const $$createType67 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType68 = $models.WorktreeStatus.createFrom;
const $$createType69 = $Create.Array($Create.Any);
const $$createType70 = $models.HighlightResult.createFrom;
const $$createType71 = $models.ImportRunHandle.createFrom;
const $$createType72 = $models.ImportUpdateResult.createFrom;
const $$createType73 = $models.InterruptAndRevertResult.createFrom;
const $$createType74 = $models.DesignOptionSet.createFrom;
const $$createType75 = $Create.Nullable($$createType74);
const $$createType76 = $Create.Array($$createType1);
const $$createType77 = store$0.Attachment.createFrom;
const $$createType78 = $Create.Array($$createType77);
const $$createType79 = $models.EditorInfo.createFrom;
const $$createType80 = $Create.Array($$createType79);
const $$createType81 = gitdiff$0.Commit.createFrom;
const $$createType82 = $Create.Array($$createType81);
const $$createType83 = store$0.ChatBarFavorite.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = $Create.Array($$createType6);
const $$createType86 = $Create.Array($$createType24);
const $$createType87 = $models.ImportScanResult.createFrom;
const $$createType88 = $Create.Array($$createType51);
const $$createType89 = store$0.PagedItems.createFrom;
const $$createType90 = $Create.Array($$createType29);
const $$createType91 = git$0.ReviewThread.createFrom;
const $$createType92 = $Create.Array($$createType91);
const $$createType93 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType94 = store$0.ProjectWithCounts.createFrom;
const $$createType95 = $Create.Array($$createType94);
const $$createType96 = $Create.Array($$createType8);
const $$createType97 = $models.ManagedProviderAccount.createFrom;
const $$createType98 = $Create.Array($$createType97);
const $$createType99 = store$0.Turn.createFrom;
const $$createType100 = $Create.Array($$createType99);
const $$createType101 = $models.ReleaseSummary.createFrom;
const $$createType102 = $Create.Array($$createType101);
const $$createType103 = $Create.Array($$createType0);
const $$createType104 = terminal$0.SessionSummary.createFrom;
const $$createType105 = $Create.Array($$createType104);
const $$createType106 = $models.EditDiffList.createFrom;
const $$createType107 = $models.ThreadMCPServer.createFrom;
const $$createType108 = $Create.Array($$createType107);
const $$createType109 = wsllauncher$0.Distro.createFrom;
const $$createType110 = $Create.Array($$createType109);
const $$createType111 = $models.TerminalHandle.createFrom;
const $$createType112 = provider$0.AccountInfo.createFrom;
const $$createType113 = $models.ProjectDeletionPreview.createFrom;
const $$createType114 = $models.ProviderTerminalHandle.createFrom;
const $$createType115 = store$0.ThreadMessageHit.createFrom;
const $$createType116 = $Create.Array($$createType115);
const $$createType117 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType118 = $models.CodexReviewStarted.createFrom;
const $$createType119 = $models.SubmitPRReviewResult.createFrom;
const $$createType120 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType121 = $models.SyncThreadWindowResponse.createFrom;
const $$createType122 = $models.MCPAuthInitResult.createFrom;
const $$createType123 = $models.VerifyEditDiffsResult.createFrom;
const $$createType124 = $models.WorkflowAgentMemoryResult.createFrom;
const $$createType125 = $models.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType126 = $models.WorkflowAgentGuideRunResult.createFrom;
const $$createType127 = $models.WorkflowAgentRunInspection.createFrom;
const $$createType128 = $models.WorkflowAgentMemoryLog.createFrom;
const $$createType129 = $models.WorkflowAgentRunView.createFrom;
const $$createType130 = $Create.Array($$createType129);
const $$createType131 = $models.WorkflowAgentNarrative.createFrom;
const $$createType132 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType133 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType134 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType135 = $models.WorkflowAgentStartResult.createFrom;
const $$createType136 = $models.WorkflowAgentWatchResult.createFrom;
const $$createType137 = store$0.WorkItem.createFrom;
const $$createType138 = $models.WorkflowAutomationView.createFrom;
const $$createType139 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType140 = $models.WorkflowDiscardPreview.createFrom;
const $$createType141 = $models.WorkflowPRReviewComments.createFrom;
const $$createType142 = engine$0.EngineState.createFrom;
const $$createType143 = $models.WorkflowItemDetailView.createFrom;
const $$createType144 = $models.WorkflowRunMapView.createFrom;
const $$createType145 = $Create.Array($$createType138);
const $$createType146 = $models.WorkflowDefinitionCatalog.createFrom;
const $$createType147 = $Create.Map($Create.Any, $Create.Any);
const $$createType148 = $Create.Array($$createType137);

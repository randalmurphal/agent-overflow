...
const $$createType6 = store$0.Thread.createFrom;
const $$createType7 = app$0.PasskeyChallengeResult.createFrom;
const $$createType8 = app$0.ThreadTransferIntent.createFrom;
const $$createType9 = store$0.ThreadTransfer.createFrom;
const $$createType10 = dirbrowse$0.Listing.createFrom;
const $$createType11 = browser$0.CompanionEvent.createFrom;
const $$createType12 = browser$0.CompanionSubscription.createFrom;
const $$createType13 = provideraccountapp$0.LoginState.createFrom;
const $$createType14 = appupdate$0.UpdateAvailability.createFrom;
const $$createType15 = app$0.ImportUpdateStatus.createFrom;
const $$createType16 = app$0.ComputerPairingView.createFrom;
const $$createType17 = app$0.ChannelStatePayload.createFrom;
const $$createType18 = store$0.DiffReviewComment.createFrom;
const $$createType19 = store$0.Project.createFrom;
const $$createType20 = store$0.ProposedPlanComment.createFrom;
const $$createType21 = store$0.ThreadGroup.createFrom;
const $$createType22 = transferclient$0.Offer.createFrom;
const $$createType23 = app$0.ProjectDeletionResult.createFrom;
const $$createType24 = settings$0.Settings.createFrom;
const $$createType25 = app$0.PairingStatusView.createFrom;
const $$createType26 = attachedbackends$0.DiscoveredComputer.createFrom;
const $$createType27 = $Create.Array($$createType26);
const $$createType28 = app$0.PasskeySummary.createFrom;
const $$createType29 = app$0.PasskeyStepUpGrant.createFrom;
const $$createType30 = network$0.Settings.createFrom;
const $$createType31 = app$0.GeneratedCommitMessage.createFrom;
const $$createType32 = app$0.AccessOverview.createFrom;
const $$createType33 = app$0.AttachmentThumbnail.createFrom;
const $$createType34 = store$0.ChannelMessage.createFrom;
const $$createType35 = $Create.Array($$createType34);
const $$createType36 = claudeconfig$0.Skill.createFrom;
const $$createType37 = $Create.Array($$createType36);
const $$createType38 = app$0.ClaudeSlashCommands.createFrom;
const $$createType39 = app$0.CodexAccountUsage.createFrom;
const $$createType40 = $Create.Nullable($$createType39);
const $$createType41 = codexskills$0.CwdSkills.createFrom;
const $$createType42 = computerroute$0.Route.createFrom;
const $$createType43 = $Create.Array($$createType42);
const $$createType44 = app$0.ContextSettingsProfile.createFrom;
const $$createType45 = app$0.ConversationMutationState.createFrom;
const $$createType46 = devscan$0.DevServerList.createFrom;
const $$createType47 = app$0.DiffContextResult.createFrom;
const $$createType48 = store$0.DiscussionDefinition.createFrom;
const $$createType49 = app$0.Draft.createFrom;
const $$createType50 = settings$0.EditorSettings.createFrom;
const $$createType51 = git$0.GitStatus.createFrom;
const $$createType52 = keybindings$0.LoadResult.createFrom;
const $$createType53 = app$0.LocalImageData.createFrom;
const $$createType54 = mcpstatus$0.ServerStatus.createFrom;
const $$createType55 = provider$0.ModelInfo.createFrom;
...
const $$createType75 = spinner$0.Files.createFrom;
const $$createType76 = app$0.TerminalReplay.createFrom;
const $$createType77 = theme$0.Files.createFrom;
const $$createType78 = app$0.ThreadContextUsage.createFrom;
const $$createType79 = app$0.ThreadDefaults.createFrom;
const $$createType80 = store$0.Item.createFrom;
const $$createType81 = app$0.ItemProjectionSource.createFrom;
const $$createType82 = app$0.ThreadLiveState.createFrom;
const $$createType83 = $Create.Array($$createType9);
const $$createType84 = store$0.TurnPreview.createFrom;
const $$createType85 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType86 = $Create.Array($$createType85);
const $$createType87 = store$0.UserMessageTick.createFrom;
const $$createType88 = $Create.Array($$createType87);
const $$createType89 = app$0.WorktreeSetupRunState.createFrom;
const $$createType90 = app$0.TurnEditsDiff.createFrom;
const $$createType91 = $Create.Map($Create.Any, $Create.Any);
const $$createType92 = store$0.UsageBucket.createFrom;
const $$createType93 = $Create.Array($$createType92);
const $$createType94 = app$0.WorkspaceActivity.createFrom;
const $$createType95 = app$0.GitWorkspaceState.createFrom;
const $$createType96 = git$0.GitActionResult.createFrom;
const $$createType97 = app$0.BranchPruneCandidates.createFrom;
const $$createType98 = git$0.GitBranch.createFrom;
const $$createType99 = $Create.Array($$createType98);
const $$createType100 = app$0.WorktreeListItem.createFrom;
const $$createType101 = $Create.Array($$createType100);
const $$createType102 = app$0.BranchPruneResult.createFrom;
const $$createType103 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType104 = app$0.WorktreeStatus.createFrom;
const $$createType105 = $Create.Array($Create.Any);
const $$createType106 = highlightapp$0.Result.createFrom;
const $$createType107 = app$0.ImportRunHandle.createFrom;
const $$createType108 = app$0.ImportUpdateResult.createFrom;
const $$createType109 = app$0.InterruptAndRevertResult.createFrom;
const $$createType110 = app$0.PairingInvite.createFrom;
const $$createType111 = $Create.Array($$createType6);
const $$createType112 = store$0.Attachment.createFrom;
const $$createType113 = $Create.Array($$createType112);
const $$createType114 = app$0.EditorInfo.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = attachedbackends$0.Attached.createFrom;
const $$createType117 = $Create.Array($$createType116);
const $$createType118 = gitdiff$0.Commit.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = store$0.ChatBarFavorite.createFrom;
const $$createType121 = $Create.Array($$createType120);
const $$createType122 = $Create.Array($$createType18);
const $$createType123 = $Create.Array($$createType48);
const $$createType124 = app$0.ImportScanResult.createFrom;
const $$createType125 = $Create.Array($$createType80);
const $$createType126 = store$0.PagedItems.createFrom;
const $$createType127 = $Create.Array($$createType54);
const $$createType128 = owndevices$0.List.createFrom;
const $$createType129 = git$0.ReviewThread.createFrom;
const $$createType130 = $Create.Array($$createType129);
const $$createType131 = $Create.Array($$createType28);
const $$createType132 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType133 = store$0.ProjectWithCounts.createFrom;
const $$createType134 = $Create.Array($$createType133);
const $$createType135 = $Create.Array($$createType20);
const $$createType136 = app$0.ManagedProviderAccount.createFrom;
const $$createType137 = $Create.Array($$createType136);
const $$createType138 = store$0.Turn.createFrom;
const $$createType139 = $Create.Array($$createType138);
const $$createType140 = appupdate$0.ReleaseSummary.createFrom;
const $$createType141 = $Create.Array($$createType140);
const $$createType142 = app$0.BackgroundWorkInventory.createFrom;
const $$createType143 = terminal$0.SessionSummary.createFrom;
const $$createType144 = $Create.Array($$createType143);
const $$createType145 = app$0.EditDiffList.createFrom;
const $$createType146 = $Create.Array($$createType21);
const $$createType147 = app$0.ThreadLiveActivity.createFrom;
const $$createType148 = $Create.Array($$createType147);
const $$createType149 = app$0.ThreadMCPServer.createFrom;
const $$createType150 = $Create.Array($$createType149);
const $$createType151 = store$0.RemoteWatch.createFrom;
const $$createType152 = $Create.Array($$createType151);
const $$createType153 = wsllauncher$0.Distro.createFrom;
const $$createType154 = $Create.Array($$createType153);
const $$createType155 = app$0.ComputerPairingWindow.createFrom;
const $$createType156 = app$0.TerminalHandle.createFrom;
const $$createType157 = provider$0.AccountInfo.createFrom;
const $$createType158 = app$0.ProjectDeletionPreview.createFrom;
const $$createType159 = app$0.ProviderTerminalHandle.createFrom;
const $$createType160 = remotejobs$0.LogChunk.createFrom;
const $$createType161 = app$0.RemoteArtifactChunk.createFrom;
const $$createType162 = app$0.RemoteCommandEnvironment.createFrom;
const $$createType163 = app$0.RemoteCommandProject.createFrom;
const $$createType164 = $Create.Array($$createType163);
const $$createType165 = remotejobs$0.LogSearch.createFrom;
const $$createType166 = app$0.RevertAndResendResult.createFrom;
const $$createType167 = app$0.DeviceRevocationResult.createFrom;
const $$createType168 = store$0.ThreadMessageHit.createFrom;
const $$createType169 = $Create.Array($$createType168);
const $$createType170 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType171 = app$0.CodexReviewStarted.createFrom;
const $$createType172 = app$0.SubmitPRReviewResult.createFrom;
const $$createType173 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType174 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType175 = app$0.MCPAuthInitResult.createFrom;
const $$createType176 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType177 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType178 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType179 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType180 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType181 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType182 = app$0.WorkflowAgentRunView.createFrom;
const $$createType183 = $Create.Array($$createType182);
const $$createType184 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType185 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType186 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType187 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType188 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType189 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType190 = store$0.WorkItem.createFrom;
const $$createType191 = app$0.WorkflowAutomationView.createFrom;
const $$createType192 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType193 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType194 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType195 = engine$0.EngineState.createFrom;
const $$createType196 = app$0.WorkflowItemDetailView.createFrom;
const $$createType197 = app$0.WorkflowRunMapView.createFrom;
const $$createType198 = $Create.Array($$createType191);
const $$createType199 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType200 = $Create.Map($Create.Any, $Create.Any);
const $$createType201 = $Create.Array($$createType190);

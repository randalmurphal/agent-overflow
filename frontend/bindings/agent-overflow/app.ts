...
const $$createType27 = keybindings$0.Keybinding.createFrom;
...
const $$createType69 = $models.InterruptAndRevertResult.createFrom;
const $$createType70 = $models.DesignOptionSet.createFrom;
const $$createType71 = $Create.Nullable($$createType70);
const $$createType72 = $Create.Array($$createType1);
const $$createType73 = store$0.Attachment.createFrom;
const $$createType74 = $Create.Array($$createType73);
const $$createType75 = $models.EditorInfo.createFrom;
const $$createType76 = $Create.Array($$createType75);
const $$createType77 = gitdiff$0.Commit.createFrom;
const $$createType78 = $Create.Array($$createType77);
const $$createType79 = store$0.ChatBarFavorite.createFrom;
const $$createType80 = $Create.Array($$createType79);
const $$createType81 = $Create.Array($$createType5);
const $$createType82 = $Create.Array($$createType23);
const $$createType83 = $Create.Array($$createType50);
...
const $$createType102 = $models.ThreadMCPServer.createFrom;
const $$createType103 = $Create.Array($$createType102);
const $$createType104 = wsllauncher$0.Distro.createFrom;
const $$createType105 = $Create.Array($$createType104);
const $$createType106 = $models.TerminalHandle.createFrom;
const $$createType107 = provider$0.AccountInfo.createFrom;
const $$createType108 = $models.ProjectDeletionPreview.createFrom;
const $$createType109 = $models.ProviderTerminalHandle.createFrom;
const $$createType110 = store$0.ThreadMessageHit.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType113 = $models.CodexReviewStarted.createFrom;
const $$createType114 = $models.SubmitPRReviewResult.createFrom;
const $$createType115 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType116 = $models.MCPAuthInitResult.createFrom;
const $$createType117 = $models.VerifyEditDiffsResult.createFrom;
const $$createType118 = $models.WorkflowAgentRunView.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType121 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType122 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType123 = $models.WorkflowAgentStartResult.createFrom;
const $$createType124 = store$0.WorkItem.createFrom;
const $$createType125 = $models.WorkflowAutomationView.createFrom;
const $$createType126 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType127 = $models.WorkflowDiscardPreview.createFrom;
const $$createType128 = $models.WorkflowPRReviewComments.createFrom;
const $$createType129 = engine$0.EngineState.createFrom;
const $$createType130 = $models.WorkflowItemDetailView.createFrom;
const $$createType131 = $Create.Array($$createType125);
const $$createType132 = $models.WorkflowDefinitionCatalog.createFrom;
const $$createType133 = $Create.Map($Create.Any, $Create.Any);
const $$createType134 = $Create.Array($$createType124);

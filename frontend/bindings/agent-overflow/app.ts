...
const $$createType41 = app$0.ContextSettingsProfile.createFrom;
const $$createType42 = devscan$0.DevServerList.createFrom;
const $$createType43 = app$0.DiffContextResult.createFrom;
const $$createType44 = store$0.DiscussionDefinition.createFrom;
const $$createType45 = app$0.Draft.createFrom;
const $$createType46 = settings$0.EditorSettings.createFrom;
const $$createType47 = git$0.GitStatus.createFrom;
const $$createType48 = keybindings$0.LoadResult.createFrom;
const $$createType49 = app$0.LocalImageData.createFrom;
const $$createType50 = mcpstatus$0.ServerStatus.createFrom;
const $$createType51 = provider$0.ModelInfo.createFrom;
const $$createType52 = $Create.Array($$createType51);
const $$createType53 = nativenetwork$0.Config.createFrom;
const $$createType54 = app$0.PRCIJobLogResult.createFrom;
const $$createType55 = git$0.CIPipeline.createFrom;
const $$createType56 = git$0.PRDetail.createFrom;
const $$createType57 = app$0.PRMergeConflictsResult.createFrom;
const $$createType58 = app$0.PayloadChunk.createFrom;
const $$createType59 = app$0.PayloadContent.createFrom;
const $$createType60 = app$0.PayloadPreview.createFrom;
const $$createType61 = app$0.WorktreeSetupConfig.createFrom;
const $$createType62 = provider$0.ProviderStatus.createFrom;
const $$createType63 = $Create.Array($$createType62);
const $$createType64 = app$0.PushSenderStatus.createFrom;
const $$createType65 = flushqueue$0.QueuedItem.createFrom;
const $$createType66 = $Create.Array($$createType65);
const $$createType67 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType68 = $Create.Array($$createType67);
const $$createType69 = sshsetup$0.Status.createFrom;
const $$createType70 = app$0.ServiceUpdateStatus.createFrom;
const $$createType71 = spinner$0.Files.createFrom;
const $$createType72 = app$0.TerminalReplay.createFrom;
const $$createType73 = theme$0.Files.createFrom;
const $$createType74 = app$0.ThreadContextUsage.createFrom;
const $$createType75 = app$0.ThreadDefaults.createFrom;
const $$createType76 = store$0.Item.createFrom;
const $$createType77 = app$0.ItemProjectionSource.createFrom;
const $$createType78 = app$0.ThreadLiveState.createFrom;
const $$createType79 = $Create.Array($$createType8);
const $$createType80 = store$0.TurnPreview.createFrom;
const $$createType81 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType82 = $Create.Array($$createType81);
const $$createType83 = store$0.UserMessageTick.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = app$0.WorktreeSetupRunState.createFrom;
const $$createType86 = app$0.TurnEditsDiff.createFrom;
const $$createType87 = $Create.Map($Create.Any, $Create.Any);
const $$createType88 = store$0.UsageBucket.createFrom;
const $$createType89 = $Create.Array($$createType88);
const $$createType90 = app$0.WorkspaceActivity.createFrom;
const $$createType91 = app$0.GitWorkspaceState.createFrom;
const $$createType92 = git$0.GitActionResult.createFrom;
const $$createType93 = app$0.BranchPruneCandidates.createFrom;
const $$createType94 = git$0.GitBranch.createFrom;
const $$createType95 = $Create.Array($$createType94);
const $$createType96 = app$0.WorktreeListItem.createFrom;
const $$createType97 = $Create.Array($$createType96);
const $$createType98 = app$0.BranchPruneResult.createFrom;
const $$createType99 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType100 = app$0.WorktreeStatus.createFrom;
const $$createType101 = $Create.Array($Create.Any);
const $$createType102 = highlightapp$0.Result.createFrom;
const $$createType103 = app$0.ImportRunHandle.createFrom;
const $$createType104 = app$0.ImportUpdateResult.createFrom;
const $$createType105 = app$0.InterruptAndRevertResult.createFrom;
const $$createType106 = app$0.PairingInvite.createFrom;
const $$createType107 = $Create.Array($$createType5);
const $$createType108 = store$0.Attachment.createFrom;
const $$createType109 = $Create.Array($$createType108);
const $$createType110 = app$0.EditorInfo.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = attachedbackends$0.Attached.createFrom;
const $$createType113 = $Create.Array($$createType112);
const $$createType114 = gitdiff$0.Commit.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = store$0.ChatBarFavorite.createFrom;
const $$createType117 = $Create.Array($$createType116);
const $$createType118 = $Create.Array($$createType17);
const $$createType119 = $Create.Array($$createType44);
const $$createType120 = app$0.ImportScanResult.createFrom;
const $$createType121 = $Create.Array($$createType76);
const $$createType122 = store$0.PagedItems.createFrom;
const $$createType123 = $Create.Array($$createType50);
const $$createType124 = owndevices$0.List.createFrom;
const $$createType125 = git$0.ReviewThread.createFrom;
const $$createType126 = $Create.Array($$createType125);
const $$createType127 = $Create.Array($$createType27);
const $$createType128 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType129 = store$0.ProjectWithCounts.createFrom;
const $$createType130 = $Create.Array($$createType129);
const $$createType131 = $Create.Array($$createType19);
const $$createType132 = app$0.ManagedProviderAccount.createFrom;
const $$createType133 = $Create.Array($$createType132);
const $$createType134 = store$0.Turn.createFrom;
const $$createType135 = $Create.Array($$createType134);
const $$createType136 = appupdate$0.ReleaseSummary.createFrom;
const $$createType137 = $Create.Array($$createType136);
const $$createType138 = app$0.BackgroundWorkInventory.createFrom;
const $$createType139 = terminal$0.SessionSummary.createFrom;
const $$createType140 = $Create.Array($$createType139);
const $$createType141 = app$0.EditDiffList.createFrom;
const $$createType142 = $Create.Array($$createType20);
const $$createType143 = app$0.ThreadMCPServer.createFrom;
const $$createType144 = $Create.Array($$createType143);
const $$createType145 = wsllauncher$0.Distro.createFrom;
const $$createType146 = $Create.Array($$createType145);
const $$createType147 = app$0.ComputerPairingWindow.createFrom;
const $$createType148 = app$0.TerminalHandle.createFrom;
const $$createType149 = provider$0.AccountInfo.createFrom;
const $$createType150 = app$0.ProjectDeletionPreview.createFrom;
const $$createType151 = app$0.ProviderTerminalHandle.createFrom;
const $$createType152 = app$0.RemoteCommandProject.createFrom;
const $$createType153 = $Create.Array($$createType152);
const $$createType154 = app$0.DeviceRevocationResult.createFrom;
const $$createType155 = store$0.ThreadMessageHit.createFrom;
const $$createType156 = $Create.Array($$createType155);
const $$createType157 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType158 = app$0.CodexReviewStarted.createFrom;
const $$createType159 = app$0.SubmitPRReviewResult.createFrom;
const $$createType160 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType161 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType162 = app$0.MCPAuthInitResult.createFrom;
const $$createType163 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType164 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType165 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType166 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType167 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType168 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType169 = app$0.WorkflowAgentRunView.createFrom;
const $$createType170 = $Create.Array($$createType169);
const $$createType171 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType172 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType173 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType174 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType175 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType176 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType177 = store$0.WorkItem.createFrom;
const $$createType178 = app$0.WorkflowAutomationView.createFrom;
const $$createType179 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType180 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType181 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType182 = engine$0.EngineState.createFrom;
const $$createType183 = app$0.WorkflowItemDetailView.createFrom;
const $$createType184 = app$0.WorkflowRunMapView.createFrom;
const $$createType185 = $Create.Array($$createType178);
const $$createType186 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType187 = $Create.Map($Create.Any, $Create.Any);
const $$createType188 = $Create.Array($$createType177);

...
const $$createType14 = claudeconfig$0.Skill.createFrom;
const $$createType15 = $Create.Array($$createType14);
const $$createType16 = $models.ClaudeSlashCommands.createFrom;
const $$createType17 = $models.CodexAccountUsage.createFrom;
const $$createType18 = $Create.Nullable($$createType17);
const $$createType19 = codexskills$0.CwdSkills.createFrom;
const $$createType20 = $models.ContextSettingsProfile.createFrom;
const $$createType21 = $models.DesignWorkdirInfo.createFrom;
const $$createType22 = $models.DiffContextResult.createFrom;
const $$createType23 = store$0.DiscussionDefinition.createFrom;
const $$createType24 = $models.Draft.createFrom;
const $$createType25 = settings$0.EditorSettings.createFrom;
const $$createType26 = git$0.GitStatus.createFrom;
const $$createType27 = keybindings$0.LoadResult.createFrom;
const $$createType28 = mcpstatus$0.ServerStatus.createFrom;
const $$createType29 = provider$0.ModelInfo.createFrom;
const $$createType30 = $Create.Array($$createType29);
const $$createType31 = network$0.Settings.createFrom;
const $$createType32 = $models.PRCIJobLogResult.createFrom;
const $$createType33 = git$0.CIPipeline.createFrom;
const $$createType34 = git$0.PRDetail.createFrom;
const $$createType35 = $models.PRMergeConflictsResult.createFrom;
const $$createType36 = $models.PayloadChunk.createFrom;
const $$createType37 = $models.PayloadContent.createFrom;
const $$createType38 = $models.PayloadPreview.createFrom;
const $$createType39 = $models.WorktreeSetupConfig.createFrom;
const $$createType40 = provider$0.ProviderStatus.createFrom;
const $$createType41 = $Create.Array($$createType40);
const $$createType42 = flushqueue$0.QueuedItem.createFrom;
const $$createType43 = $Create.Array($$createType42);
const $$createType44 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType45 = $Create.Array($$createType44);
const $$createType46 = $models.TerminalReplay.createFrom;
const $$createType47 = $models.ThreadContextUsage.createFrom;
const $$createType48 = $models.ThreadDefaults.createFrom;
const $$createType49 = store$0.Item.createFrom;
const $$createType50 = $models.ThreadLiveState.createFrom;
const $$createType51 = $models.WorktreeSetupRunState.createFrom;
const $$createType52 = $models.TurnEditsDiff.createFrom;
const $$createType53 = $Create.Map($Create.Any, $Create.Any);
const $$createType54 = store$0.UsageBucket.createFrom;
const $$createType55 = $Create.Array($$createType54);
const $$createType56 = $models.GitWorkspaceState.createFrom;
const $$createType57 = git$0.GitActionResult.createFrom;
const $$createType58 = $models.BranchPruneCandidates.createFrom;
const $$createType59 = git$0.GitBranch.createFrom;
const $$createType60 = $Create.Array($$createType59);
const $$createType61 = $models.WorktreeListItem.createFrom;
const $$createType62 = $Create.Array($$createType61);
const $$createType63 = $models.BranchPruneResult.createFrom;
const $$createType64 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType65 = $models.WorktreeStatus.createFrom;
const $$createType66 = $Create.Array($Create.Any);
const $$createType67 = $models.HighlightResult.createFrom;
const $$createType68 = $models.InterruptAndRevertResult.createFrom;
const $$createType69 = $models.DesignOptionSet.createFrom;
const $$createType70 = $Create.Nullable($$createType69);
const $$createType71 = $Create.Array($$createType1);
const $$createType72 = store$0.Attachment.createFrom;
const $$createType73 = $Create.Array($$createType72);
const $$createType74 = $models.EditorInfo.createFrom;
...
const $$createType78 = store$0.ChatBarFavorite.createFrom;
const $$createType79 = $Create.Array($$createType78);
const $$createType80 = $Create.Array($$createType5);
const $$createType81 = $Create.Array($$createType23);
const $$createType82 = $Create.Array($$createType49);
const $$createType83 = store$0.PagedItems.createFrom;
const $$createType84 = $Create.Array($$createType28);
const $$createType85 = git$0.ReviewThread.createFrom;
const $$createType86 = $Create.Array($$createType85);
const $$createType87 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType88 = store$0.ProjectWithCounts.createFrom;
const $$createType89 = $Create.Array($$createType88);
const $$createType90 = $Create.Array($$createType7);
const $$createType91 = $models.ManagedProviderAccount.createFrom;
const $$createType92 = $Create.Array($$createType91);
const $$createType93 = store$0.Turn.createFrom;
const $$createType94 = $Create.Array($$createType93);
const $$createType95 = $models.ReleaseSummary.createFrom;
const $$createType96 = $Create.Array($$createType95);
const $$createType97 = $Create.Array($$createType0);
const $$createType98 = terminal$0.SessionSummary.createFrom;
const $$createType99 = $Create.Array($$createType98);
const $$createType100 = $models.EditDiffList.createFrom;
const $$createType101 = $models.ThreadMCPServer.createFrom;
const $$createType102 = $Create.Array($$createType101);
const $$createType103 = wsllauncher$0.Distro.createFrom;
const $$createType104 = $Create.Array($$createType103);
const $$createType105 = $models.TerminalHandle.createFrom;
const $$createType106 = provider$0.AccountInfo.createFrom;
const $$createType107 = $models.ProjectDeletionPreview.createFrom;
const $$createType108 = $models.ProviderTerminalHandle.createFrom;
const $$createType109 = store$0.ThreadMessageHit.createFrom;
const $$createType110 = $Create.Array($$createType109);
const $$createType111 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType112 = $models.CodexReviewStarted.createFrom;
const $$createType113 = $models.SubmitPRReviewResult.createFrom;
const $$createType114 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType115 = $models.MCPAuthInitResult.createFrom;
const $$createType116 = $models.VerifyEditDiffsResult.createFrom;
const $$createType117 = $models.WorkflowAgentRunView.createFrom;
const $$createType118 = $Create.Array($$createType117);
const $$createType119 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType120 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType121 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType122 = $models.WorkflowAgentStartResult.createFrom;
const $$createType123 = store$0.WorkItem.createFrom;
const $$createType124 = $models.WorkflowAutomationView.createFrom;
const $$createType125 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType126 = $models.WorkflowDiscardPreview.createFrom;
const $$createType127 = $models.WorkflowPRReviewComments.createFrom;
const $$createType128 = engine$0.EngineState.createFrom;
const $$createType129 = $models.WorkflowItemDetailView.createFrom;
const $$createType130 = $Create.Array($$createType124);
const $$createType131 = $models.WorkflowDefinitionCatalog.createFrom;
const $$createType132 = $Create.Map($Create.Any, $Create.Any);
const $$createType133 = $Create.Array($$createType123);

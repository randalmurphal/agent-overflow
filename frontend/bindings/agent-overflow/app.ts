...
const $$createType55 = store$0.UserMessageTick.createFrom;
const $$createType56 = $Create.Array($$createType55);
const $$createType57 = $models.WorktreeSetupRunState.createFrom;
const $$createType58 = $models.TurnEditsDiff.createFrom;
const $$createType59 = $Create.Map($Create.Any, $Create.Any);
const $$createType60 = store$0.UsageBucket.createFrom;
const $$createType61 = $Create.Array($$createType60);
const $$createType62 = $models.WorkspaceActivity.createFrom;
const $$createType63 = $models.GitWorkspaceState.createFrom;
const $$createType64 = git$0.GitActionResult.createFrom;
const $$createType65 = $models.BranchPruneCandidates.createFrom;
const $$createType66 = git$0.GitBranch.createFrom;
const $$createType67 = $Create.Array($$createType66);
const $$createType68 = $models.WorktreeListItem.createFrom;
const $$createType69 = $Create.Array($$createType68);
const $$createType70 = $models.BranchPruneResult.createFrom;
const $$createType71 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType72 = $models.WorktreeStatus.createFrom;
const $$createType73 = $Create.Array($Create.Any);
const $$createType74 = $models.HighlightResult.createFrom;
const $$createType75 = $models.ImportRunHandle.createFrom;
const $$createType76 = $models.ImportUpdateResult.createFrom;
const $$createType77 = $models.InterruptAndRevertResult.createFrom;
const $$createType78 = $models.DesignOptionSet.createFrom;
const $$createType79 = $Create.Nullable($$createType78);
const $$createType80 = $Create.Array($$createType2);
const $$createType81 = store$0.Attachment.createFrom;
const $$createType82 = $Create.Array($$createType81);
const $$createType83 = $models.EditorInfo.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = gitdiff$0.Commit.createFrom;
const $$createType86 = $Create.Array($$createType85);
const $$createType87 = store$0.ChatBarFavorite.createFrom;
const $$createType88 = $Create.Array($$createType87);
const $$createType89 = $Create.Array($$createType7);
const $$createType90 = $Create.Array($$createType25);
const $$createType91 = $models.ImportScanResult.createFrom;
const $$createType92 = $Create.Array($$createType52);
const $$createType93 = store$0.PagedItems.createFrom;
const $$createType94 = $Create.Array($$createType30);
const $$createType95 = git$0.ReviewThread.createFrom;
const $$createType96 = $Create.Array($$createType95);
const $$createType97 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType98 = store$0.ProjectWithCounts.createFrom;
const $$createType99 = $Create.Array($$createType98);
const $$createType100 = $Create.Array($$createType9);
const $$createType101 = $models.ManagedProviderAccount.createFrom;
const $$createType102 = $Create.Array($$createType101);
const $$createType103 = store$0.Turn.createFrom;
const $$createType104 = $Create.Array($$createType103);
const $$createType105 = $models.ReleaseSummary.createFrom;
const $$createType106 = $Create.Array($$createType105);
const $$createType107 = $Create.Array($$createType0);
const $$createType108 = terminal$0.SessionSummary.createFrom;
const $$createType109 = $Create.Array($$createType108);
const $$createType110 = $models.EditDiffList.createFrom;
const $$createType111 = $models.ThreadMCPServer.createFrom;
const $$createType112 = $Create.Array($$createType111);
const $$createType113 = wsllauncher$0.Distro.createFrom;
const $$createType114 = $Create.Array($$createType113);
const $$createType115 = $models.TerminalHandle.createFrom;
const $$createType116 = provider$0.AccountInfo.createFrom;
const $$createType117 = $models.ProjectDeletionPreview.createFrom;
const $$createType118 = $models.ProviderTerminalHandle.createFrom;
const $$createType119 = store$0.ThreadMessageHit.createFrom;
const $$createType120 = $Create.Array($$createType119);
const $$createType121 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType122 = $models.CodexReviewStarted.createFrom;
const $$createType123 = $models.SubmitPRReviewResult.createFrom;
const $$createType124 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType125 = $models.SyncThreadWindowResponse.createFrom;
const $$createType126 = $models.MCPAuthInitResult.createFrom;
const $$createType127 = $models.VerifyEditDiffsResult.createFrom;
const $$createType128 = $models.WorkflowAgentMemoryResult.createFrom;
const $$createType129 = $models.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType130 = $models.WorkflowAgentGuideRunResult.createFrom;
const $$createType131 = $models.WorkflowAgentRunInspection.createFrom;
const $$createType132 = $models.WorkflowAgentMemoryLog.createFrom;
const $$createType133 = $models.WorkflowAgentRunView.createFrom;
const $$createType134 = $Create.Array($$createType133);
const $$createType135 = $models.WorkflowAgentNarrative.createFrom;
const $$createType136 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType137 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType138 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType139 = $models.WorkflowAgentStartResult.createFrom;
const $$createType140 = $models.WorkflowAgentWatchResult.createFrom;
const $$createType141 = store$0.WorkItem.createFrom;
const $$createType142 = $models.WorkflowAutomationView.createFrom;
const $$createType143 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType144 = $models.WorkflowDiscardPreview.createFrom;
const $$createType145 = $models.WorkflowPRReviewComments.createFrom;
const $$createType146 = engine$0.EngineState.createFrom;
const $$createType147 = $models.WorkflowItemDetailView.createFrom;
const $$createType148 = $models.WorkflowRunMapView.createFrom;
const $$createType149 = $Create.Array($$createType142);
const $$createType150 = $models.WorkflowDefinitionCatalog.createFrom;
const $$createType151 = $Create.Map($Create.Any, $Create.Any);
const $$createType152 = $Create.Array($$createType141);

 ...
 */
export function GetLocalImageData(path: string, workspacePath: string): $CancellablePromise<$models.LocalImageData> {
...
const $$createType30 = $models.LocalImageData.createFrom;
...
const $$createType35 = $models.PRCIJobLogResult.createFrom;
const $$createType36 = git$0.CIPipeline.createFrom;
const $$createType37 = git$0.PRDetail.createFrom;
const $$createType38 = $models.PRMergeConflictsResult.createFrom;
const $$createType39 = $models.PayloadChunk.createFrom;
const $$createType40 = $models.PayloadContent.createFrom;
const $$createType41 = $models.PayloadPreview.createFrom;
const $$createType42 = $models.WorktreeSetupConfig.createFrom;
...
const $$createType50 = $models.TerminalReplay.createFrom;
const $$createType51 = theme$0.Files.createFrom;
const $$createType52 = $models.ThreadContextUsage.createFrom;
const $$createType53 = $models.ThreadDefaults.createFrom;
const $$createType54 = store$0.Item.createFrom;
const $$createType55 = $models.ThreadLiveState.createFrom;
...
const $$createType61 = $models.WorktreeSetupRunState.createFrom;
const $$createType62 = $models.TurnEditsDiff.createFrom;
...
const $$createType66 = $models.WorkspaceActivity.createFrom;
const $$createType67 = $models.GitWorkspaceState.createFrom;
const $$createType68 = git$0.GitActionResult.createFrom;
const $$createType69 = $models.BranchPruneCandidates.createFrom;
const $$createType70 = git$0.GitBranch.createFrom;
const $$createType71 = $Create.Array($$createType70);
const $$createType72 = $models.WorktreeListItem.createFrom;
const $$createType73 = $Create.Array($$createType72);
const $$createType74 = $models.BranchPruneResult.createFrom;
const $$createType75 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType76 = $models.WorktreeStatus.createFrom;
const $$createType77 = $Create.Array($Create.Any);
const $$createType78 = $models.HighlightResult.createFrom;
const $$createType79 = $models.ImportRunHandle.createFrom;
const $$createType80 = $models.ImportUpdateResult.createFrom;
const $$createType81 = $models.InterruptAndRevertResult.createFrom;
const $$createType82 = $models.DesignOptionSet.createFrom;
const $$createType83 = $Create.Nullable($$createType82);
const $$createType84 = $Create.Array($$createType2);
const $$createType85 = store$0.Attachment.createFrom;
const $$createType86 = $Create.Array($$createType85);
const $$createType87 = $models.EditorInfo.createFrom;
const $$createType88 = $Create.Array($$createType87);
const $$createType89 = gitdiff$0.Commit.createFrom;
const $$createType90 = $Create.Array($$createType89);
const $$createType91 = store$0.ChatBarFavorite.createFrom;
const $$createType92 = $Create.Array($$createType91);
const $$createType93 = $Create.Array($$createType7);
const $$createType94 = $Create.Array($$createType25);
const $$createType95 = $models.ImportScanResult.createFrom;
const $$createType96 = $Create.Array($$createType54);
const $$createType97 = store$0.PagedItems.createFrom;
const $$createType98 = $Create.Array($$createType31);
const $$createType99 = git$0.ReviewThread.createFrom;
const $$createType100 = $Create.Array($$createType99);
const $$createType101 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType102 = store$0.ProjectWithCounts.createFrom;
const $$createType103 = $Create.Array($$createType102);
const $$createType104 = $Create.Array($$createType9);
const $$createType105 = $models.ManagedProviderAccount.createFrom;
const $$createType106 = $Create.Array($$createType105);
const $$createType107 = store$0.Turn.createFrom;
const $$createType108 = $Create.Array($$createType107);
const $$createType109 = $models.ReleaseSummary.createFrom;
const $$createType110 = $Create.Array($$createType109);
const $$createType111 = $Create.Array($$createType0);
const $$createType112 = terminal$0.SessionSummary.createFrom;
const $$createType113 = $Create.Array($$createType112);
const $$createType114 = $models.EditDiffList.createFrom;
const $$createType115 = $models.ThreadMCPServer.createFrom;
...
const $$createType119 = $models.TerminalHandle.createFrom;
const $$createType120 = provider$0.AccountInfo.createFrom;
const $$createType121 = $models.ProjectDeletionPreview.createFrom;
const $$createType122 = $models.ProviderTerminalHandle.createFrom;
const $$createType123 = store$0.ThreadMessageHit.createFrom;
const $$createType124 = $Create.Array($$createType123);
const $$createType125 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType126 = $models.CodexReviewStarted.createFrom;
const $$createType127 = $models.SubmitPRReviewResult.createFrom;
const $$createType128 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType129 = $models.SyncThreadWindowResponse.createFrom;
const $$createType130 = $models.MCPAuthInitResult.createFrom;
const $$createType131 = $models.VerifyEditDiffsResult.createFrom;
const $$createType132 = $models.WorkflowAgentMemoryResult.createFrom;
const $$createType133 = $models.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType134 = $models.WorkflowAgentGuideRunResult.createFrom;
const $$createType135 = $models.WorkflowAgentRunInspection.createFrom;
const $$createType136 = $models.WorkflowAgentMemoryLog.createFrom;
const $$createType137 = $models.WorkflowAgentRunView.createFrom;
const $$createType138 = $Create.Array($$createType137);
const $$createType139 = $models.WorkflowAgentNarrative.createFrom;
const $$createType140 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType141 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType142 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType143 = $models.WorkflowAgentStartResult.createFrom;
const $$createType144 = $models.WorkflowAgentWatchResult.createFrom;
const $$createType145 = store$0.WorkItem.createFrom;
const $$createType146 = $models.WorkflowAutomationView.createFrom;
const $$createType147 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType148 = $models.WorkflowDiscardPreview.createFrom;
const $$createType149 = $models.WorkflowPRReviewComments.createFrom;
const $$createType150 = engine$0.EngineState.createFrom;
const $$createType151 = $models.WorkflowItemDetailView.createFrom;
const $$createType152 = $models.WorkflowRunMapView.createFrom;
const $$createType153 = $Create.Array($$createType146);
const $$createType154 = $models.WorkflowDefinitionCatalog.createFrom;

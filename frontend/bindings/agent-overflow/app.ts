...
const $$createType13 = app$0.PairingStatusView.createFrom;
const $$createType14 = network$0.Settings.createFrom;
const $$createType15 = app$0.GeneratedCommitMessage.createFrom;
const $$createType16 = app$0.AccessOverview.createFrom;
const $$createType17 = app$0.AttachmentThumbnail.createFrom;
const $$createType18 = store$0.ChannelMessage.createFrom;
const $$createType19 = $Create.Array($$createType18);
const $$createType20 = claudeconfig$0.Skill.createFrom;
const $$createType21 = $Create.Array($$createType20);
const $$createType22 = app$0.ClaudeSlashCommands.createFrom;
const $$createType23 = app$0.CodexAccountUsage.createFrom;
const $$createType24 = $Create.Nullable($$createType23);
const $$createType25 = codexskills$0.CwdSkills.createFrom;
const $$createType26 = app$0.ContextSettingsProfile.createFrom;
const $$createType27 = app$0.DiffContextResult.createFrom;
const $$createType28 = store$0.DiscussionDefinition.createFrom;
const $$createType29 = app$0.Draft.createFrom;
const $$createType30 = settings$0.EditorSettings.createFrom;
const $$createType31 = git$0.GitStatus.createFrom;
const $$createType32 = keybindings$0.LoadResult.createFrom;
const $$createType33 = app$0.LocalImageData.createFrom;
const $$createType34 = mcpstatus$0.ServerStatus.createFrom;
const $$createType35 = provider$0.ModelInfo.createFrom;
const $$createType36 = $Create.Array($$createType35);
const $$createType37 = app$0.PRCIJobLogResult.createFrom;
const $$createType38 = git$0.CIPipeline.createFrom;
const $$createType39 = git$0.PRDetail.createFrom;
const $$createType40 = app$0.PRMergeConflictsResult.createFrom;
const $$createType41 = app$0.PayloadChunk.createFrom;
const $$createType42 = app$0.PayloadContent.createFrom;
const $$createType43 = app$0.PayloadPreview.createFrom;
const $$createType44 = app$0.WorktreeSetupConfig.createFrom;
const $$createType45 = provider$0.ProviderStatus.createFrom;
const $$createType46 = $Create.Array($$createType45);
const $$createType47 = flushqueue$0.QueuedItem.createFrom;
const $$createType48 = $Create.Array($$createType47);
const $$createType49 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType50 = $Create.Array($$createType49);
const $$createType51 = spinner$0.Files.createFrom;
const $$createType52 = app$0.TerminalReplay.createFrom;
const $$createType53 = theme$0.Files.createFrom;
const $$createType54 = app$0.ThreadContextUsage.createFrom;
const $$createType55 = app$0.ThreadDefaults.createFrom;
const $$createType56 = store$0.Item.createFrom;
const $$createType57 = app$0.ItemProjectionSource.createFrom;
const $$createType58 = app$0.ThreadLiveState.createFrom;
const $$createType59 = store$0.TurnPreview.createFrom;
const $$createType60 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType61 = $Create.Array($$createType60);
const $$createType62 = store$0.UserMessageTick.createFrom;
const $$createType63 = $Create.Array($$createType62);
const $$createType64 = app$0.WorktreeSetupRunState.createFrom;
const $$createType65 = app$0.TurnEditsDiff.createFrom;
const $$createType66 = $Create.Map($Create.Any, $Create.Any);
const $$createType67 = store$0.UsageBucket.createFrom;
const $$createType68 = $Create.Array($$createType67);
const $$createType69 = app$0.WorkspaceActivity.createFrom;
const $$createType70 = app$0.GitWorkspaceState.createFrom;
const $$createType71 = git$0.GitActionResult.createFrom;
const $$createType72 = app$0.BranchPruneCandidates.createFrom;
const $$createType73 = git$0.GitBranch.createFrom;
const $$createType74 = $Create.Array($$createType73);
const $$createType75 = app$0.WorktreeListItem.createFrom;
const $$createType76 = $Create.Array($$createType75);
const $$createType77 = app$0.BranchPruneResult.createFrom;
const $$createType78 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType79 = app$0.WorktreeStatus.createFrom;
const $$createType80 = $Create.Array($Create.Any);
const $$createType81 = app$0.HighlightResult.createFrom;
const $$createType82 = app$0.ImportRunHandle.createFrom;
const $$createType83 = app$0.ImportUpdateResult.createFrom;
const $$createType84 = app$0.InterruptAndRevertResult.createFrom;
...
const $$createType88 = app$0.EditorInfo.createFrom;
...
const $$createType95 = $Create.Array($$createType28);
const $$createType96 = app$0.ImportScanResult.createFrom;
const $$createType97 = $Create.Array($$createType56);
const $$createType98 = store$0.PagedItems.createFrom;
const $$createType99 = $Create.Array($$createType34);
...
const $$createType106 = app$0.ManagedProviderAccount.createFrom;
...
const $$createType110 = app$0.ReleaseSummary.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = $Create.Array($$createType0);
const $$createType113 = app$0.BackgroundWorkInventory.createFrom;
const $$createType114 = terminal$0.SessionSummary.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = app$0.EditDiffList.createFrom;
const $$createType117 = app$0.ThreadMCPServer.createFrom;
const $$createType118 = $Create.Array($$createType117);
const $$createType119 = wsllauncher$0.Distro.createFrom;
const $$createType120 = $Create.Array($$createType119);
const $$createType121 = app$0.PairingInvite.createFrom;
const $$createType122 = app$0.TerminalHandle.createFrom;
const $$createType123 = provider$0.AccountInfo.createFrom;
const $$createType124 = app$0.ProjectDeletionPreview.createFrom;
const $$createType125 = app$0.ProviderTerminalHandle.createFrom;
const $$createType126 = app$0.DeviceRevocationResult.createFrom;
const $$createType127 = store$0.ThreadMessageHit.createFrom;
const $$createType128 = $Create.Array($$createType127);
const $$createType129 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType130 = app$0.CodexReviewStarted.createFrom;
const $$createType131 = app$0.SubmitPRReviewResult.createFrom;
const $$createType132 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType133 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType134 = app$0.MCPAuthInitResult.createFrom;
const $$createType135 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType136 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType137 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType138 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType139 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType140 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType141 = app$0.WorkflowAgentRunView.createFrom;
const $$createType142 = $Create.Array($$createType141);
const $$createType143 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType144 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType145 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType146 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType147 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType148 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType149 = store$0.WorkItem.createFrom;
const $$createType150 = app$0.WorkflowAutomationView.createFrom;
const $$createType151 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType152 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType153 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType154 = engine$0.EngineState.createFrom;
const $$createType155 = app$0.WorkflowItemDetailView.createFrom;
const $$createType156 = app$0.WorkflowRunMapView.createFrom;
const $$createType157 = $Create.Array($$createType150);
const $$createType158 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType159 = $Create.Map($Create.Any, $Create.Any);
const $$createType160 = $Create.Array($$createType149);

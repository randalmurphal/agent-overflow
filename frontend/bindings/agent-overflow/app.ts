...
const $$createType107 = store$0.Attachment.createFrom;
const $$createType108 = $Create.Array($$createType107);
const $$createType109 = app$0.EditorInfo.createFrom;
const $$createType110 = $Create.Array($$createType109);
const $$createType111 = attachedbackends$0.Attached.createFrom;
const $$createType112 = $Create.Array($$createType111);
const $$createType113 = gitdiff$0.Commit.createFrom;
const $$createType114 = $Create.Array($$createType113);
const $$createType115 = store$0.ChatBarFavorite.createFrom;
const $$createType116 = $Create.Array($$createType115);
const $$createType117 = $Create.Array($$createType17);
const $$createType118 = $Create.Array($$createType44);
const $$createType119 = app$0.ImportScanResult.createFrom;
const $$createType120 = $Create.Array($$createType76);
const $$createType121 = store$0.PagedItems.createFrom;
const $$createType122 = $Create.Array($$createType50);
const $$createType123 = git$0.ReviewThread.createFrom;
const $$createType124 = $Create.Array($$createType123);
const $$createType125 = $Create.Array($$createType27);
const $$createType126 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType127 = store$0.ProjectWithCounts.createFrom;
const $$createType128 = $Create.Array($$createType127);
const $$createType129 = $Create.Array($$createType19);
const $$createType130 = app$0.ManagedProviderAccount.createFrom;
const $$createType131 = $Create.Array($$createType130);
const $$createType132 = store$0.Turn.createFrom;
const $$createType133 = $Create.Array($$createType132);
const $$createType134 = appupdate$0.ReleaseSummary.createFrom;
const $$createType135 = $Create.Array($$createType134);
const $$createType136 = app$0.BackgroundWorkInventory.createFrom;
const $$createType137 = terminal$0.SessionSummary.createFrom;
const $$createType138 = $Create.Array($$createType137);
const $$createType139 = app$0.EditDiffList.createFrom;
const $$createType140 = $Create.Array($$createType20);
const $$createType141 = app$0.ThreadMCPServer.createFrom;
const $$createType142 = $Create.Array($$createType141);
const $$createType143 = wsllauncher$0.Distro.createFrom;
const $$createType144 = $Create.Array($$createType143);
const $$createType145 = app$0.PairingInvite.createFrom;
const $$createType146 = app$0.ComputerPairingWindow.createFrom;
const $$createType147 = app$0.TerminalHandle.createFrom;
const $$createType148 = provider$0.AccountInfo.createFrom;
const $$createType149 = app$0.ProjectDeletionPreview.createFrom;
const $$createType150 = app$0.ProviderTerminalHandle.createFrom;
const $$createType151 = app$0.RemoteCommandProject.createFrom;
const $$createType152 = $Create.Array($$createType151);
const $$createType153 = app$0.DeviceRevocationResult.createFrom;
const $$createType154 = store$0.ThreadMessageHit.createFrom;
const $$createType155 = $Create.Array($$createType154);
const $$createType156 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType157 = app$0.CodexReviewStarted.createFrom;
const $$createType158 = app$0.SubmitPRReviewResult.createFrom;
const $$createType159 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType160 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType161 = app$0.MCPAuthInitResult.createFrom;
const $$createType162 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType163 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType164 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType165 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType166 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType167 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType168 = app$0.WorkflowAgentRunView.createFrom;
const $$createType169 = $Create.Array($$createType168);
const $$createType170 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType171 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType172 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType173 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType174 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType175 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType176 = store$0.WorkItem.createFrom;
const $$createType177 = app$0.WorkflowAutomationView.createFrom;
const $$createType178 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType179 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType180 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType181 = engine$0.EngineState.createFrom;
const $$createType182 = app$0.WorkflowItemDetailView.createFrom;
const $$createType183 = app$0.WorkflowRunMapView.createFrom;
const $$createType184 = $Create.Array($$createType177);
const $$createType185 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType186 = $Create.Map($Create.Any, $Create.Any);
const $$createType187 = $Create.Array($$createType176);

 ...
 */
export function ListRunningBackgroundWork(): $CancellablePromise<app$0.RunningBackgroundWork[]> {
...
const $$createType110 = app$0.RunningBackgroundWork.createFrom;
...
const $$createType114 = app$0.EditDiffList.createFrom;

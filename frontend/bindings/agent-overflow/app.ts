...
const $$createType24 = $models.DesignWorkdirInfo.createFrom;
const $$createType25 = $models.DiffContextResult.createFrom;
const $$createType26 = store$0.DiscussionDefinition.createFrom;
const $$createType27 = $models.Draft.createFrom;
...
const $$createType31 = $models.LocalImageData.createFrom;
...
const $$createType36 = $models.PRCIJobLogResult.createFrom;
const $$createType37 = git$0.CIPipeline.createFrom;
const $$createType38 = git$0.PRDetail.createFrom;
const $$createType39 = $models.PRMergeConflictsResult.createFrom;
const $$createType40 = $models.PayloadChunk.createFrom;
const $$createType41 = $models.PayloadContent.createFrom;
const $$createType42 = $models.PayloadPreview.createFrom;
const $$createType43 = $models.WorktreeSetupConfig.createFrom;
...
const $$createType51 = $models.TerminalReplay.createFrom;
const $$createType52 = theme$0.Files.createFrom;
const $$createType53 = $models.ThreadContextUsage.createFrom;
const $$createType54 = $models.ThreadDefaults.createFrom;
const $$createType55 = store$0.Item.createFrom;
const $$createType56 = $models.ThreadLiveState.createFrom;
...
const $$createType62 = $models.WorktreeSetupRunState.createFrom;
const $$createType63 = $models.TurnEditsDiff.createFrom;
...
const $$createType67 = $models.WorkspaceActivity.createFrom;
const $$createType68 = $models.GitWorkspaceState.createFrom;
const $$createType69 = git$0.GitActionResult.createFrom;
const $$createType70 = $models.BranchPruneCandidates.createFrom;
const $$createType71 = git$0.GitBranch.createFrom;
const $$createType72 = $Create.Array($$createType71);
const $$createType73 = $models.WorktreeListItem.createFrom;
const $$createType74 = $Create.Array($$createType73);
const $$createType75 = $models.BranchPruneResult.createFrom;
const $$createType76 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType77 = $models.WorktreeStatus.createFrom;
const $$createType78 = $Create.Array($Create.Any);
const $$createType79 = $models.HighlightResult.createFrom;
const $$createType80 = $models.ImportRunHandle.createFrom;
const $$createType81 = $models.ImportUpdateResult.createFrom;
const $$createType82 = $models.InterruptAndRevertResult.createFrom;
const $$createType83 = $models.DesignOptionSet.createFrom;
const $$createType84 = $Create.Nullable($$createType83);
const $$createType85 = $Create.Array($$createType1);
const $$createType86 = store$0.Attachment.createFrom;
const $$createType87 = $Create.Array($$createType86);
const $$createType88 = $models.EditorInfo.createFrom;
const $$createType89 = $Create.Array($$createType88);
const $$createType90 = gitdiff$0.Commit.createFrom;
const $$createType91 = $Create.Array($$createType90);
const $$createType92 = store$0.ChatBarFavorite.createFrom;
const $$createType93 = $Create.Array($$createType92);
const $$createType94 = $Create.Array($$createType8);
const $$createType95 = $Create.Array($$createType26);
const $$createType96 = $models.ImportScanResult.createFrom;
const $$createType97 = $Create.Array($$createType55);
const $$createType98 = store$0.PagedItems.createFrom;
const $$createType99 = $Create.Array($$createType32);
const $$createType100 = git$0.ReviewThread.createFrom;
const $$createType101 = $Create.Array($$createType100);
const $$createType102 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType103 = store$0.ProjectWithCounts.createFrom;
const $$createType104 = $Create.Array($$createType103);
const $$createType105 = $Create.Array($$createType10);
const $$createType106 = $models.ManagedProviderAccount.createFrom;
const $$createType107 = $Create.Array($$createType106);
const $$createType108 = store$0.Turn.createFrom;
const $$createType109 = $Create.Array($$createType108);
const $$createType110 = $models.ReleaseSummary.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = $Create.Array($$createType0);
const $$createType113 = terminal$0.SessionSummary.createFrom;
const $$createType114 = $Create.Array($$createType113);
const $$createType115 = $models.EditDiffList.createFrom;
const $$createType116 = $models.ThreadMCPServer.createFrom;
const $$createType117 = $Create.Array($$createType116);
const $$createType118 = wsllauncher$0.Distro.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = $models.TerminalHandle.createFrom;
const $$createType121 = provider$0.AccountInfo.createFrom;
const $$createType122 = $models.ProjectDeletionPreview.createFrom;
const $$createType123 = $models.ProviderTerminalHandle.createFrom;
const $$createType124 = store$0.ThreadMessageHit.createFrom;
const $$createType125 = $Create.Array($$createType124);
const $$createType126 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType127 = $models.CodexReviewStarted.createFrom;
const $$createType128 = $models.SubmitPRReviewResult.createFrom;
const $$createType129 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType130 = $models.SyncThreadWindowResponse.createFrom;
const $$createType131 = $models.MCPAuthInitResult.createFrom;
const $$createType132 = $models.VerifyEditDiffsResult.createFrom;
const $$createType133 = $models.WorkflowAgentMemoryResult.createFrom;
const $$createType134 = $models.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType135 = $models.WorkflowAgentGuideRunResult.createFrom;
const $$createType136 = $models.WorkflowAgentRunInspection.createFrom;
const $$createType137 = $models.WorkflowAgentMemoryLog.createFrom;
const $$createType138 = $models.WorkflowAgentRunView.createFrom;
const $$createType139 = $Create.Array($$createType138);
const $$createType140 = $models.WorkflowAgentNarrative.createFrom;
const $$createType141 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType142 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType143 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType144 = $models.WorkflowAgentStartResult.createFrom;
const $$createType145 = $models.WorkflowAgentWatchResult.createFrom;
const $$createType146 = store$0.WorkItem.createFrom;
const $$createType147 = $models.WorkflowAutomationView.createFrom;
const $$createType148 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType149 = $models.WorkflowDiscardPreview.createFrom;
const $$createType150 = $models.WorkflowPRReviewComments.createFrom;
const $$createType151 = engine$0.EngineState.createFrom;
const $$createType152 = $models.WorkflowItemDetailView.createFrom;
const $$createType153 = $models.WorkflowRunMapView.createFrom;
const $$createType154 = $Create.Array($$createType147);
const $$createType155 = $models.WorkflowDefinitionCatalog.createFrom;
const $$createType156 = $Create.Map($Create.Any, $Create.Any);
const $$createType157 = $Create.Array($$createType146);

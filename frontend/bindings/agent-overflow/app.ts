...
const $$createType45 = devscan$0.DevServerList.createFrom;
const $$createType46 = app$0.DiffContextResult.createFrom;
const $$createType47 = store$0.DiscussionDefinition.createFrom;
const $$createType48 = app$0.Draft.createFrom;
const $$createType49 = settings$0.EditorSettings.createFrom;
const $$createType50 = git$0.GitStatus.createFrom;
const $$createType51 = keybindings$0.LoadResult.createFrom;
const $$createType52 = app$0.LocalImageData.createFrom;
const $$createType53 = mcpstatus$0.ServerStatus.createFrom;
const $$createType54 = provider$0.ModelInfo.createFrom;
const $$createType55 = $Create.Array($$createType54);
const $$createType56 = nativenetwork$0.Config.createFrom;
const $$createType57 = app$0.PRCIJobLogResult.createFrom;
const $$createType58 = git$0.CIPipeline.createFrom;
const $$createType59 = git$0.PRDetail.createFrom;
const $$createType60 = app$0.PRMergeConflictsResult.createFrom;
const $$createType61 = app$0.PayloadChunk.createFrom;
const $$createType62 = app$0.PayloadContent.createFrom;
const $$createType63 = app$0.PayloadPreview.createFrom;
const $$createType64 = app$0.WorktreeSetupConfig.createFrom;
const $$createType65 = provider$0.ProviderStatus.createFrom;
const $$createType66 = $Create.Array($$createType65);
const $$createType67 = app$0.PushSenderStatus.createFrom;
const $$createType68 = flushqueue$0.QueuedItem.createFrom;
const $$createType69 = $Create.Array($$createType68);
const $$createType70 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType71 = $Create.Array($$createType70);
const $$createType72 = sshsetup$0.Status.createFrom;
const $$createType73 = app$0.ServiceUpdateStatus.createFrom;
const $$createType74 = spinner$0.Files.createFrom;
const $$createType75 = app$0.TerminalReplay.createFrom;
const $$createType76 = theme$0.Files.createFrom;
const $$createType77 = app$0.ThreadContextUsage.createFrom;
const $$createType78 = app$0.ThreadDefaults.createFrom;
const $$createType79 = store$0.Item.createFrom;
const $$createType80 = app$0.ItemProjectionSource.createFrom;
const $$createType81 = app$0.ThreadLiveState.createFrom;
const $$createType82 = $Create.Array($$createType9);
const $$createType83 = store$0.TurnPreview.createFrom;
const $$createType84 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType85 = $Create.Array($$createType84);
const $$createType86 = store$0.UserMessageTick.createFrom;
const $$createType87 = $Create.Array($$createType86);
const $$createType88 = app$0.WorktreeSetupRunState.createFrom;
const $$createType89 = app$0.TurnEditsDiff.createFrom;
const $$createType90 = $Create.Map($Create.Any, $Create.Any);
const $$createType91 = store$0.UsageBucket.createFrom;
const $$createType92 = $Create.Array($$createType91);
const $$createType93 = app$0.WorkspaceActivity.createFrom;
const $$createType94 = app$0.GitWorkspaceState.createFrom;
const $$createType95 = git$0.GitActionResult.createFrom;
const $$createType96 = app$0.BranchPruneCandidates.createFrom;
const $$createType97 = git$0.GitBranch.createFrom;
const $$createType98 = $Create.Array($$createType97);
const $$createType99 = app$0.WorktreeListItem.createFrom;
const $$createType100 = $Create.Array($$createType99);
const $$createType101 = app$0.BranchPruneResult.createFrom;
const $$createType102 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType103 = app$0.WorktreeStatus.createFrom;
const $$createType104 = $Create.Array($Create.Any);
const $$createType105 = highlightapp$0.Result.createFrom;
const $$createType106 = app$0.ImportRunHandle.createFrom;
const $$createType107 = app$0.ImportUpdateResult.createFrom;
const $$createType108 = app$0.InterruptAndRevertResult.createFrom;
const $$createType109 = app$0.PairingInvite.createFrom;
const $$createType110 = $Create.Array($$createType6);
const $$createType111 = store$0.Attachment.createFrom;
const $$createType112 = $Create.Array($$createType111);
const $$createType113 = app$0.EditorInfo.createFrom;
const $$createType114 = $Create.Array($$createType113);
const $$createType115 = attachedbackends$0.Attached.createFrom;
...
const $$createType119 = store$0.ChatBarFavorite.createFrom;
const $$createType120 = $Create.Array($$createType119);
const $$createType121 = $Create.Array($$createType18);
const $$createType122 = $Create.Array($$createType47);
const $$createType123 = app$0.ImportScanResult.createFrom;
const $$createType124 = $Create.Array($$createType79);
const $$createType125 = store$0.PagedItems.createFrom;
const $$createType126 = $Create.Array($$createType53);
const $$createType127 = owndevices$0.List.createFrom;
const $$createType128 = git$0.ReviewThread.createFrom;
const $$createType129 = $Create.Array($$createType128);
const $$createType130 = $Create.Array($$createType28);
const $$createType131 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType132 = store$0.ProjectWithCounts.createFrom;
const $$createType133 = $Create.Array($$createType132);
const $$createType134 = $Create.Array($$createType20);
const $$createType135 = app$0.ManagedProviderAccount.createFrom;
const $$createType136 = $Create.Array($$createType135);
const $$createType137 = store$0.Turn.createFrom;
const $$createType138 = $Create.Array($$createType137);
const $$createType139 = appupdate$0.ReleaseSummary.createFrom;
const $$createType140 = $Create.Array($$createType139);
const $$createType141 = app$0.BackgroundWorkInventory.createFrom;
const $$createType142 = terminal$0.SessionSummary.createFrom;
const $$createType143 = $Create.Array($$createType142);
const $$createType144 = app$0.EditDiffList.createFrom;
const $$createType145 = $Create.Array($$createType21);
const $$createType146 = app$0.ThreadLiveActivity.createFrom;
const $$createType147 = $Create.Array($$createType146);
const $$createType148 = app$0.ThreadMCPServer.createFrom;
const $$createType149 = $Create.Array($$createType148);
const $$createType150 = store$0.RemoteWatch.createFrom;
const $$createType151 = $Create.Array($$createType150);
const $$createType152 = wsllauncher$0.Distro.createFrom;
const $$createType153 = $Create.Array($$createType152);
const $$createType154 = app$0.ComputerPairingWindow.createFrom;
const $$createType155 = app$0.TerminalHandle.createFrom;
const $$createType156 = provider$0.AccountInfo.createFrom;
const $$createType157 = app$0.ProjectDeletionPreview.createFrom;
const $$createType158 = app$0.ProviderTerminalHandle.createFrom;
const $$createType159 = remotejobs$0.LogChunk.createFrom;
const $$createType160 = app$0.RemoteArtifactChunk.createFrom;
const $$createType161 = app$0.RemoteCommandEnvironment.createFrom;
const $$createType162 = app$0.RemoteCommandProject.createFrom;
const $$createType163 = $Create.Array($$createType162);
const $$createType164 = remotejobs$0.LogSearch.createFrom;
const $$createType165 = app$0.DeviceRevocationResult.createFrom;
const $$createType166 = store$0.ThreadMessageHit.createFrom;
const $$createType167 = $Create.Array($$createType166);
const $$createType168 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType169 = app$0.CodexReviewStarted.createFrom;
const $$createType170 = app$0.SubmitPRReviewResult.createFrom;
const $$createType171 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType172 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType173 = app$0.MCPAuthInitResult.createFrom;
const $$createType174 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType175 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType176 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType177 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType178 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType179 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType180 = app$0.WorkflowAgentRunView.createFrom;
const $$createType181 = $Create.Array($$createType180);
const $$createType182 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType183 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType184 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType185 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType186 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType187 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType188 = store$0.WorkItem.createFrom;
const $$createType189 = app$0.WorkflowAutomationView.createFrom;
const $$createType190 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType191 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType192 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType193 = engine$0.EngineState.createFrom;
const $$createType194 = app$0.WorkflowItemDetailView.createFrom;
const $$createType195 = app$0.WorkflowRunMapView.createFrom;
const $$createType196 = $Create.Array($$createType189);
const $$createType197 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType198 = $Create.Map($Create.Any, $Create.Any);
const $$createType199 = $Create.Array($$createType188);

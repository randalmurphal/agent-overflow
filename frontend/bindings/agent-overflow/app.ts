...
const $$createType6 = app$0.UpdateAvailability.createFrom;
const $$createType7 = app$0.ImportUpdateStatus.createFrom;
const $$createType8 = app$0.ChannelStatePayload.createFrom;
const $$createType9 = store$0.DiffReviewComment.createFrom;
const $$createType10 = store$0.Project.createFrom;
const $$createType11 = store$0.ProposedPlanComment.createFrom;
const $$createType12 = app$0.ProjectDeletionResult.createFrom;
const $$createType13 = settings$0.Settings.createFrom;
const $$createType14 = app$0.PairingStatusView.createFrom;
const $$createType15 = app$0.PasskeySummary.createFrom;
const $$createType16 = app$0.PasskeyStepUpGrant.createFrom;
const $$createType17 = network$0.Settings.createFrom;
const $$createType18 = app$0.GeneratedCommitMessage.createFrom;
const $$createType19 = app$0.AccessOverview.createFrom;
const $$createType20 = app$0.AttachmentThumbnail.createFrom;
const $$createType21 = store$0.ChannelMessage.createFrom;
const $$createType22 = $Create.Array($$createType21);
const $$createType23 = claudeconfig$0.Skill.createFrom;
const $$createType24 = $Create.Array($$createType23);
const $$createType25 = app$0.ClaudeSlashCommands.createFrom;
const $$createType26 = app$0.CodexAccountUsage.createFrom;
const $$createType27 = $Create.Nullable($$createType26);
const $$createType28 = codexskills$0.CwdSkills.createFrom;
const $$createType29 = app$0.ContextSettingsProfile.createFrom;
const $$createType30 = app$0.DiffContextResult.createFrom;
const $$createType31 = store$0.DiscussionDefinition.createFrom;
const $$createType32 = app$0.Draft.createFrom;
const $$createType33 = settings$0.EditorSettings.createFrom;
const $$createType34 = git$0.GitStatus.createFrom;
const $$createType35 = keybindings$0.LoadResult.createFrom;
const $$createType36 = app$0.LocalImageData.createFrom;
const $$createType37 = mcpstatus$0.ServerStatus.createFrom;
const $$createType38 = provider$0.ModelInfo.createFrom;
const $$createType39 = $Create.Array($$createType38);
const $$createType40 = app$0.PRCIJobLogResult.createFrom;
const $$createType41 = git$0.CIPipeline.createFrom;
const $$createType42 = git$0.PRDetail.createFrom;
const $$createType43 = app$0.PRMergeConflictsResult.createFrom;
const $$createType44 = app$0.PayloadChunk.createFrom;
const $$createType45 = app$0.PayloadContent.createFrom;
const $$createType46 = app$0.PayloadPreview.createFrom;
const $$createType47 = app$0.WorktreeSetupConfig.createFrom;
const $$createType48 = provider$0.ProviderStatus.createFrom;
const $$createType49 = $Create.Array($$createType48);
const $$createType50 = flushqueue$0.QueuedItem.createFrom;
const $$createType51 = $Create.Array($$createType50);
const $$createType52 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType53 = $Create.Array($$createType52);
const $$createType54 = spinner$0.Files.createFrom;
const $$createType55 = app$0.TerminalReplay.createFrom;
const $$createType56 = theme$0.Files.createFrom;
const $$createType57 = app$0.ThreadContextUsage.createFrom;
const $$createType58 = app$0.ThreadDefaults.createFrom;
const $$createType59 = store$0.Item.createFrom;
const $$createType60 = app$0.ItemProjectionSource.createFrom;
const $$createType61 = app$0.ThreadLiveState.createFrom;
const $$createType62 = store$0.TurnPreview.createFrom;
const $$createType63 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType64 = $Create.Array($$createType63);
const $$createType65 = store$0.UserMessageTick.createFrom;
const $$createType66 = $Create.Array($$createType65);
const $$createType67 = app$0.WorktreeSetupRunState.createFrom;
const $$createType68 = app$0.TurnEditsDiff.createFrom;
const $$createType69 = $Create.Map($Create.Any, $Create.Any);
const $$createType70 = store$0.UsageBucket.createFrom;
const $$createType71 = $Create.Array($$createType70);
const $$createType72 = app$0.WorkspaceActivity.createFrom;
const $$createType73 = app$0.GitWorkspaceState.createFrom;
const $$createType74 = git$0.GitActionResult.createFrom;
const $$createType75 = app$0.BranchPruneCandidates.createFrom;
const $$createType76 = git$0.GitBranch.createFrom;
const $$createType77 = $Create.Array($$createType76);
const $$createType78 = app$0.WorktreeListItem.createFrom;
const $$createType79 = $Create.Array($$createType78);
const $$createType80 = app$0.BranchPruneResult.createFrom;
const $$createType81 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType82 = app$0.WorktreeStatus.createFrom;
const $$createType83 = $Create.Array($Create.Any);
const $$createType84 = app$0.HighlightResult.createFrom;
const $$createType85 = app$0.ImportRunHandle.createFrom;
const $$createType86 = app$0.ImportUpdateResult.createFrom;
const $$createType87 = app$0.InterruptAndRevertResult.createFrom;
const $$createType88 = $Create.Array($$createType1);
const $$createType89 = store$0.Attachment.createFrom;
const $$createType90 = $Create.Array($$createType89);
const $$createType91 = app$0.EditorInfo.createFrom;
const $$createType92 = $Create.Array($$createType91);
const $$createType93 = gitdiff$0.Commit.createFrom;
const $$createType94 = $Create.Array($$createType93);
const $$createType95 = store$0.ChatBarFavorite.createFrom;
const $$createType96 = $Create.Array($$createType95);
const $$createType97 = $Create.Array($$createType9);
const $$createType98 = $Create.Array($$createType31);
const $$createType99 = app$0.ImportScanResult.createFrom;
const $$createType100 = $Create.Array($$createType59);
const $$createType101 = store$0.PagedItems.createFrom;
const $$createType102 = $Create.Array($$createType37);
const $$createType103 = git$0.ReviewThread.createFrom;
const $$createType104 = $Create.Array($$createType103);
const $$createType105 = $Create.Array($$createType15);
const $$createType106 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType107 = store$0.ProjectWithCounts.createFrom;
const $$createType108 = $Create.Array($$createType107);
const $$createType109 = $Create.Array($$createType11);
const $$createType110 = app$0.ManagedProviderAccount.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = store$0.Turn.createFrom;
const $$createType113 = $Create.Array($$createType112);
const $$createType114 = app$0.ReleaseSummary.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = $Create.Array($$createType0);
const $$createType117 = app$0.BackgroundWorkInventory.createFrom;
const $$createType118 = terminal$0.SessionSummary.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = app$0.EditDiffList.createFrom;
const $$createType121 = app$0.ThreadMCPServer.createFrom;
const $$createType122 = $Create.Array($$createType121);
const $$createType123 = wsllauncher$0.Distro.createFrom;
const $$createType124 = $Create.Array($$createType123);
const $$createType125 = app$0.PairingInvite.createFrom;
const $$createType126 = app$0.TerminalHandle.createFrom;
const $$createType127 = provider$0.AccountInfo.createFrom;
const $$createType128 = app$0.ProjectDeletionPreview.createFrom;
const $$createType129 = app$0.ProviderTerminalHandle.createFrom;
const $$createType130 = app$0.DeviceRevocationResult.createFrom;
const $$createType131 = store$0.ThreadMessageHit.createFrom;
const $$createType132 = $Create.Array($$createType131);
const $$createType133 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType134 = app$0.CodexReviewStarted.createFrom;
const $$createType135 = app$0.SubmitPRReviewResult.createFrom;
const $$createType136 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType137 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType138 = app$0.MCPAuthInitResult.createFrom;
const $$createType139 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType140 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType141 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType142 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType143 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType144 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType145 = app$0.WorkflowAgentRunView.createFrom;
const $$createType146 = $Create.Array($$createType145);
const $$createType147 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType148 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType149 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType150 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType151 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType152 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType153 = store$0.WorkItem.createFrom;
const $$createType154 = app$0.WorkflowAutomationView.createFrom;
const $$createType155 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType156 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType157 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType158 = engine$0.EngineState.createFrom;
const $$createType159 = app$0.WorkflowItemDetailView.createFrom;
const $$createType160 = app$0.WorkflowRunMapView.createFrom;
const $$createType161 = $Create.Array($$createType154);
const $$createType162 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType163 = $Create.Map($Create.Any, $Create.Any);
const $$createType164 = $Create.Array($$createType153);

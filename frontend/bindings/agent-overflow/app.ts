...
const $$createType112 = $Create.Array($$createType7);
const $$createType113 = store$0.Attachment.createFrom;
const $$createType114 = $Create.Array($$createType113);
const $$createType115 = app$0.EditorInfo.createFrom;
const $$createType116 = $Create.Array($$createType115);
const $$createType117 = attachedbackends$0.Attached.createFrom;
const $$createType118 = $Create.Array($$createType117);
const $$createType119 = gitdiff$0.Commit.createFrom;
const $$createType120 = $Create.Array($$createType119);
const $$createType121 = store$0.ChatBarFavorite.createFrom;
const $$createType122 = $Create.Array($$createType121);
const $$createType123 = $Create.Array($$createType19);
const $$createType124 = $Create.Array($$createType49);
const $$createType125 = app$0.ImportScanResult.createFrom;
const $$createType126 = $Create.Array($$createType81);
const $$createType127 = store$0.PagedItems.createFrom;
const $$createType128 = $Create.Array($$createType55);
const $$createType129 = owndevices$0.List.createFrom;
const $$createType130 = git$0.ReviewThread.createFrom;
const $$createType131 = $Create.Array($$createType130);
const $$createType132 = $Create.Array($$createType29);
const $$createType133 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType134 = store$0.ProjectWithCounts.createFrom;
const $$createType135 = $Create.Array($$createType134);
const $$createType136 = $Create.Array($$createType21);
const $$createType137 = app$0.ManagedProviderAccount.createFrom;
const $$createType138 = $Create.Array($$createType137);
const $$createType139 = store$0.Turn.createFrom;
const $$createType140 = $Create.Array($$createType139);
const $$createType141 = appupdate$0.ReleaseSummary.createFrom;
const $$createType142 = $Create.Array($$createType141);
const $$createType143 = app$0.BackgroundWorkInventory.createFrom;
const $$createType144 = terminal$0.SessionSummary.createFrom;
const $$createType145 = $Create.Array($$createType144);
const $$createType146 = app$0.EditDiffList.createFrom;
const $$createType147 = $Create.Array($$createType22);
const $$createType148 = app$0.ThreadLiveActivity.createFrom;
...
const $$createType156 = app$0.ComputerPairingWindow.createFrom;
const $$createType157 = app$0.TerminalHandle.createFrom;
const $$createType158 = provider$0.AccountInfo.createFrom;
const $$createType159 = app$0.ProjectDeletionPreview.createFrom;
const $$createType160 = app$0.ProviderTerminalHandle.createFrom;
const $$createType161 = remotejobs$0.LogChunk.createFrom;
const $$createType162 = app$0.RemoteArtifactChunk.createFrom;
const $$createType163 = app$0.RemoteCommandEnvironment.createFrom;
const $$createType164 = app$0.RemoteCommandProject.createFrom;
const $$createType165 = $Create.Array($$createType164);
const $$createType166 = remotejobs$0.LogSearch.createFrom;
const $$createType167 = app$0.RevertAndResendResult.createFrom;
const $$createType168 = app$0.DeviceRevocationResult.createFrom;
const $$createType169 = store$0.ThreadMessageHit.createFrom;
const $$createType170 = $Create.Array($$createType169);
const $$createType171 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType172 = app$0.CodexReviewStarted.createFrom;
const $$createType173 = app$0.SubmitPRReviewResult.createFrom;
const $$createType174 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType175 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType176 = app$0.MCPAuthInitResult.createFrom;
const $$createType177 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType178 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType179 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType180 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType181 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType182 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType183 = app$0.WorkflowAgentRunView.createFrom;
const $$createType184 = $Create.Array($$createType183);
const $$createType185 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType186 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType187 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType188 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType189 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType190 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType191 = store$0.WorkItem.createFrom;
const $$createType192 = app$0.WorkflowAutomationView.createFrom;
const $$createType193 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType194 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType195 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType196 = engine$0.EngineState.createFrom;
const $$createType197 = app$0.WorkflowItemDetailView.createFrom;
const $$createType198 = app$0.WorkflowRunMapView.createFrom;
const $$createType199 = $Create.Array($$createType192);
const $$createType200 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType201 = $Create.Map($Create.Any, $Create.Any);
const $$createType202 = $Create.Array($$createType191);

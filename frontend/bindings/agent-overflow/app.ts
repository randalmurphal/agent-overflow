 ...
 * over it.
 */
export function AttachProjectWorktree(projectID: string, branch: string): $CancellablePromise<$models.ProjectWorkspaceResult> {
    return $Call.ByID(2577753756, projectID, branch).then(($result: any) => {
 ...
 */
export function CheckThreadImportUpdates(threadID: string): $CancellablePromise<$models.ImportUpdateStatus> {
 ...
 */
export function CreateProjectBranch(projectID: string, name: string, baseBranch: string, carryLocalChanges: boolean, sourceWorkspace: string): $CancellablePromise<$models.ProjectWorkspaceResult> {
    return $Call.ByID(502820718, projectID, name, baseBranch, carryLocalChanges, sourceWorkspace).then(($result: any) => {
        return $$createType1($result);
    });
}
 ...
 */
export function DeleteProject(id: string): $CancellablePromise<$models.ProjectDeletionResult> {
 ...
 */
export function GetClaudeSlashCommands(): $CancellablePromise<$models.ClaudeSlashCommands> {
 ...
 */
export function GetCodexAccountUsage(): $CancellablePromise<$models.CodexAccountUsage | null> {
 ...
 */
export function GetDiffContextLines(threadID: string, req: $models.DiffContextRequest): $CancellablePromise<$models.DiffContextResult> {
 ...
 */
export function GetProjectWorktreeSetup(projectID: string): $CancellablePromise<$models.WorktreeSetupConfig> {
 ...
 */
export function GetThreadContextUsage(threadID: string): $CancellablePromise<$models.ThreadContextUsage> {
 ...
 */
export function GetThreadWorktreeSetup(threadID: string): $CancellablePromise<$models.WorktreeSetupRunState> {
 ...
 */
export function GetTurnEditsDiff(threadID: string, turnIndex: number): $CancellablePromise<$models.TurnEditsDiff> {
 ...
 */
export function GetWorkspaceActivity(workspacePath: string): $CancellablePromise<$models.WorkspaceActivity> {
 ...
 */
export function GetWorkspaceWorktreeSetup(projectID: string, worktreePath: string): $CancellablePromise<$models.WorktreeSetupRunState> {
    return $Call.ByID(960806842, projectID, worktreePath).then(($result: any) => {
        return $$createType59($result);
    });
}
 ...
 */
export function GitListBranchPruneCandidates(threadID: string): $CancellablePromise<$models.BranchPruneCandidates> {
 ...
 */
export function GitPruneBranches(threadID: string, selections: $models.BranchPruneSelection[]): $CancellablePromise<$models.BranchPruneResult> {
 ...
 */
export function HighlightCode(req: $models.HighlightCodeRequest): $CancellablePromise<$models.HighlightResult> {
 ...
 */
export function HighlightPatch(req: $models.HighlightPatchRequest): $CancellablePromise<$models.HighlightResult> {
 ...
 */
export function HighlightPatchWithContext(threadID: string, req: $models.HighlightPatchContextRequest): $CancellablePromise<$models.HighlightResult> {
 ...
 * twice.
 */
export function ImportSessions(req: $models.ImportSessionsRequest): $CancellablePromise<$models.ImportRunHandle> {
 ...
 */
export function ImportThreadUpdates(threadID: string): $CancellablePromise<$models.ImportUpdateResult> {
 ...
 * non-git workspaces.
 */
export function ListBranchCommits(threadID: string, baseBranch: string): $CancellablePromise<$models.BranchCommit[]> {
 ...
 */
export function ListImportableSessions(req: $models.ImportScanRequest): $CancellablePromise<$models.ImportScanResult> {
...
export function ListProviderAccounts(): $CancellablePromise<$models.ManagedProviderAccount[]> {
 ...
 */
export function ListThreadMcpServers(threadID: string): $CancellablePromise<$models.ThreadMCPServer[]> {
 ...
 * ignored.
 */
export function ListWorkspaceMcpServers(providerName: string, workspacePath: string): $CancellablePromise<$models.ThreadMCPServer[]> {
 ...
 * over it.
 */
export function PrepareProjectWorktree(projectID: string, baseBranch: string, requestedBranch: string, carryLocalChanges: boolean, sourceWorkspace: string): $CancellablePromise<$models.ProjectWorkspaceResult> {
    return $Call.ByID(2661174564, projectID, baseBranch, requestedBranch, carryLocalChanges, sourceWorkspace).then(($result: any) => {
        return $$createType1($result);
    });
}
 ...
 */
export function ProjectDeletionPreview(projectID: string): $CancellablePromise<$models.ProjectDeletionPreview> {
 ...
 * LocalOnly: this executes the project's argv commands. RCE-equivalent.
 */
export function RetryWorkspaceWorktreeSetup(projectID: string, worktreePath: string): $CancellablePromise<void> {
    return $Call.ByID(3315344348, projectID, worktreePath);
}
 ...
 */
export function SetProjectWorktreeSetup(projectID: string, config: $models.WorktreeSetupConfig): $CancellablePromise<$models.WorktreeSetupConfig> {
 ...
 * LocalOnly: it drives the thread's live provider subprocess.
 */
export function StartCodexReview(threadID: string, target: $models.CodexReviewTarget): $CancellablePromise<$models.CodexReviewStarted> {
 ...
 */
export function SubscribePRUpdates(pr: git$0.PRReference): $CancellablePromise<$models.PRUpdateSubscriptionResult> {
    return $Call.ByID(3272491649, pr).then(($result: any) => {
        return $$createType126($result);
    });
}

export function SwitchProviderAccount(providerName: string, accountID: string): $CancellablePromise<$models.ManagedProviderAccount> {
 ...
 * window only.
 */
export function SyncThreadWindow(threadID: string, req: $models.SyncThreadWindowRequest): $CancellablePromise<$models.SyncThreadWindowResponse> {
 ...
 */
export function WorkflowAgentAddMemory(input: $models.WorkflowAgentMemoryInput): $CancellablePromise<$models.WorkflowAgentMemoryResult> {
 ...
 */
export function WorkflowAgentAmendSeeds(input: $models.WorkflowAgentAmendSeedsInput): $CancellablePromise<$models.WorkflowAgentAmendSeedsResult> {
 ...
 */
export function WorkflowAgentGuideRun(input: $models.WorkflowAgentGuideRunInput): $CancellablePromise<$models.WorkflowAgentGuideRunResult> {
 ...
 */
export function WorkflowAgentInspectRun(input: $models.WorkflowAgentInspectInput): $CancellablePromise<$models.WorkflowAgentRunInspection> {
 ...
 */
export function WorkflowAgentListMemory(input: $models.WorkflowAgentMemoryListInput): $CancellablePromise<$models.WorkflowAgentMemoryLog> {
 ...
 * LocalOnly: see WorkflowAgentRunStatus.
 */
export function WorkflowAgentListRuns(activeOnly: boolean): $CancellablePromise<$models.WorkflowAgentRunView[]> {
 ...
 */
export function WorkflowAgentRunNarrative(input: $models.WorkflowAgentNarrativeInput): $CancellablePromise<$models.WorkflowAgentNarrative> {
 ...
 * LocalOnly: see WorkflowAgentRunStatus.
 */
export function WorkflowAgentRunOutput(itemID: string): $CancellablePromise<$models.WorkflowAgentRunOutputs> {
 ...
 */
export function WorkflowAgentRunStatus(itemID: string): $CancellablePromise<$models.WorkflowAgentRunView> {
 ...
 */
export function WorkflowAgentSchedule(input: $models.WorkflowAgentScheduleInput): $CancellablePromise<$models.WorkflowAgentScheduleResult> {
 ...
 */
export function WorkflowAgentSetNotes(automationID: string, notes: string): $CancellablePromise<$models.WorkflowAgentNotesResult> {
 ...
 */
export function WorkflowAgentStartRun(input: $models.WorkflowAgentStartInput): $CancellablePromise<$models.WorkflowAgentStartResult> {
 ...
 */
export function WorkflowAgentWatchRun(input: $models.WorkflowAgentWatchInput): $CancellablePromise<$models.WorkflowAgentWatchResult> {
...
const $$createType1 = $models.ProjectWorkspaceResult.createFrom;
const $$createType2 = store$0.Thread.createFrom;
const $$createType3 = dirbrowse$0.Listing.createFrom;
const $$createType4 = $models.UpdateAvailability.createFrom;
const $$createType5 = $models.ImportUpdateStatus.createFrom;
const $$createType6 = $models.ChannelStatePayload.createFrom;
const $$createType7 = store$0.DiffReviewComment.createFrom;
const $$createType8 = store$0.Project.createFrom;
const $$createType9 = store$0.ProposedPlanComment.createFrom;
const $$createType10 = $models.ProjectDeletionResult.createFrom;
const $$createType11 = settings$0.Settings.createFrom;
const $$createType12 = $models.GeneratedCommitMessage.createFrom;
const $$createType13 = $models.AttachmentThumbnail.createFrom;
const $$createType14 = store$0.ChannelMessage.createFrom;
const $$createType15 = $Create.Array($$createType14);
const $$createType16 = claudeconfig$0.Skill.createFrom;
const $$createType17 = $Create.Array($$createType16);
const $$createType18 = $models.ClaudeSlashCommands.createFrom;
const $$createType19 = $models.CodexAccountUsage.createFrom;
const $$createType20 = $Create.Nullable($$createType19);
const $$createType21 = codexskills$0.CwdSkills.createFrom;
const $$createType22 = $models.ContextSettingsProfile.createFrom;
const $$createType23 = $models.DesignWorkdirInfo.createFrom;
const $$createType24 = $models.DiffContextResult.createFrom;
const $$createType25 = store$0.DiscussionDefinition.createFrom;
const $$createType26 = $models.Draft.createFrom;
...
const $$createType30 = mcpstatus$0.ServerStatus.createFrom;
const $$createType31 = provider$0.ModelInfo.createFrom;
const $$createType32 = $Create.Array($$createType31);
const $$createType33 = network$0.Settings.createFrom;
const $$createType34 = $models.PRCIJobLogResult.createFrom;
const $$createType35 = git$0.CIPipeline.createFrom;
const $$createType36 = git$0.PRDetail.createFrom;
const $$createType37 = $models.PRMergeConflictsResult.createFrom;
const $$createType38 = $models.PayloadChunk.createFrom;
const $$createType39 = $models.PayloadContent.createFrom;
const $$createType40 = $models.PayloadPreview.createFrom;
const $$createType41 = $models.WorktreeSetupConfig.createFrom;
const $$createType42 = provider$0.ProviderStatus.createFrom;
const $$createType43 = $Create.Array($$createType42);
const $$createType44 = flushqueue$0.QueuedItem.createFrom;
const $$createType45 = $Create.Array($$createType44);
const $$createType46 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType47 = $Create.Array($$createType46);
const $$createType48 = $models.TerminalReplay.createFrom;
const $$createType49 = theme$0.Files.createFrom;
const $$createType50 = $models.ThreadContextUsage.createFrom;
const $$createType51 = $models.ThreadDefaults.createFrom;
const $$createType52 = store$0.Item.createFrom;
const $$createType53 = $models.ThreadLiveState.createFrom;
const $$createType54 = store$0.TurnPreview.createFrom;
const $$createType55 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType56 = $Create.Array($$createType55);
const $$createType57 = store$0.UserMessageTick.createFrom;
const $$createType58 = $Create.Array($$createType57);
const $$createType59 = $models.WorktreeSetupRunState.createFrom;
const $$createType60 = $models.TurnEditsDiff.createFrom;
const $$createType61 = $Create.Map($Create.Any, $Create.Any);
const $$createType62 = store$0.UsageBucket.createFrom;
const $$createType63 = $Create.Array($$createType62);
const $$createType64 = $models.WorkspaceActivity.createFrom;
const $$createType65 = $models.GitWorkspaceState.createFrom;
const $$createType66 = git$0.GitActionResult.createFrom;
const $$createType67 = $models.BranchPruneCandidates.createFrom;
const $$createType68 = git$0.GitBranch.createFrom;
const $$createType69 = $Create.Array($$createType68);
const $$createType70 = $models.WorktreeListItem.createFrom;
const $$createType71 = $Create.Array($$createType70);
const $$createType72 = $models.BranchPruneResult.createFrom;
const $$createType73 = $models.GitStatusSubscriptionResult.createFrom;
const $$createType74 = $models.WorktreeStatus.createFrom;
const $$createType75 = $Create.Array($Create.Any);
const $$createType76 = $models.HighlightResult.createFrom;
const $$createType77 = $models.ImportRunHandle.createFrom;
const $$createType78 = $models.ImportUpdateResult.createFrom;
const $$createType79 = $models.InterruptAndRevertResult.createFrom;
const $$createType80 = $models.DesignOptionSet.createFrom;
const $$createType81 = $Create.Nullable($$createType80);
const $$createType82 = $Create.Array($$createType2);
const $$createType83 = store$0.Attachment.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = $models.EditorInfo.createFrom;
...
const $$createType91 = $Create.Array($$createType7);
const $$createType92 = $Create.Array($$createType25);
const $$createType93 = $models.ImportScanResult.createFrom;
const $$createType94 = $Create.Array($$createType52);
const $$createType95 = store$0.PagedItems.createFrom;
const $$createType96 = $Create.Array($$createType30);
...
const $$createType102 = $Create.Array($$createType9);
const $$createType103 = $models.ManagedProviderAccount.createFrom;
...
const $$createType107 = $models.ReleaseSummary.createFrom;
...
const $$createType112 = $models.EditDiffList.createFrom;
const $$createType113 = $models.ThreadMCPServer.createFrom;
...
const $$createType117 = $models.TerminalHandle.createFrom;
const $$createType118 = provider$0.AccountInfo.createFrom;
const $$createType119 = $models.ProjectDeletionPreview.createFrom;
const $$createType120 = $models.ProviderTerminalHandle.createFrom;
const $$createType121 = store$0.ThreadMessageHit.createFrom;
const $$createType122 = $Create.Array($$createType121);
const $$createType123 = $models.WorkspaceFileSearchResult.createFrom;
const $$createType124 = $models.CodexReviewStarted.createFrom;
const $$createType125 = $models.SubmitPRReviewResult.createFrom;
const $$createType126 = $models.PRUpdateSubscriptionResult.createFrom;
const $$createType127 = $models.SyncThreadWindowResponse.createFrom;
const $$createType128 = $models.MCPAuthInitResult.createFrom;
const $$createType129 = $models.VerifyEditDiffsResult.createFrom;
const $$createType130 = $models.WorkflowAgentMemoryResult.createFrom;
const $$createType131 = $models.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType132 = $models.WorkflowAgentGuideRunResult.createFrom;
const $$createType133 = $models.WorkflowAgentRunInspection.createFrom;
const $$createType134 = $models.WorkflowAgentMemoryLog.createFrom;
const $$createType135 = $models.WorkflowAgentRunView.createFrom;
const $$createType136 = $Create.Array($$createType135);
const $$createType137 = $models.WorkflowAgentNarrative.createFrom;
const $$createType138 = $models.WorkflowAgentRunOutputs.createFrom;
const $$createType139 = $models.WorkflowAgentScheduleResult.createFrom;
const $$createType140 = $models.WorkflowAgentNotesResult.createFrom;
const $$createType141 = $models.WorkflowAgentStartResult.createFrom;
const $$createType142 = $models.WorkflowAgentWatchResult.createFrom;
const $$createType143 = store$0.WorkItem.createFrom;
const $$createType144 = $models.WorkflowAutomationView.createFrom;
const $$createType145 = $models.WorkflowDispositionReceipt.createFrom;
const $$createType146 = $models.WorkflowDiscardPreview.createFrom;
const $$createType147 = $models.WorkflowPRReviewComments.createFrom;
const $$createType148 = engine$0.EngineState.createFrom;
const $$createType149 = $models.WorkflowItemDetailView.createFrom;
const $$createType150 = $models.WorkflowRunMapView.createFrom;
const $$createType151 = $Create.Array($$createType144);
const $$createType152 = $models.WorkflowDefinitionCatalog.createFrom;

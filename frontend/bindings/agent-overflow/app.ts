...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
import * as computerroute$0 from "./internal/computerroute/models.js";
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
import * as nativenetwork$0 from "./internal/nativenetwork/models.js";
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
...
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
import * as soundlib$0 from "./internal/soundlib/models.js";
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
 ...
 */
export function AgentRemoteFetchArtifact(computerID: string, id: string, path: string): $CancellablePromise<app$0.RemoteArtifact> {
    return $Call.ByID(2421300190, computerID, id, path).then(($result: any) => {
 ...
 */
export function AgentRemoteFetchLog(computerID: string, id: string): $CancellablePromise<app$0.RemoteLogArtifact> {
    return $Call.ByID(2233479686, computerID, id).then(($result: any) => {
...
export function CancelThreadRemoteCommand(threadID: string, computerID: string, requestID: string): $CancellablePromise<app$0.RemoteCommand> {
    return $Call.ByID(378941854, threadID, computerID, requestID).then(($result: any) => {
        return $$createType1($result);
    });
}
 ...
 */
export function CloseComputerPairing(id: string): $CancellablePromise<void> {
    return $Call.ByID(2321581502, id);
}
 ...
 */
export function ComputerPairingStatus(id: string): $CancellablePromise<app$0.ComputerPairingView> {
    return $Call.ByID(2151872702, id).then(($result: any) => {
 ...
 */
export function DeleteSoundFile(id: string): $CancellablePromise<void> {
    return $Call.ByID(2725195951, id);
}
 ...
 */
export function DiscoverComputers(): $CancellablePromise<attachedbackends$0.DiscoveredComputer[]> {
    return $Call.ByID(4113468152).then(($result: any) => {
 ...
 */
export function GetComputerRoutes(): $CancellablePromise<computerroute$0.Route[]> {
    return $Call.ByID(873893084).then(($result: any) => {
 ...
 */
export function GetConversationMutationState(threadID: string, userItemID: string, sendID: string): $CancellablePromise<app$0.ConversationMutationState> {
    return $Call.ByID(3307838728, threadID, userItemID, sendID).then(($result: any) => {
 ...
 */
export function InterruptAndRevertIfClean(threadID: string, opts: app$0.InterruptRevertOptions): $CancellablePromise<app$0.InterruptAndRevertResult> {
    return $Call.ByID(753394581, threadID, opts).then(($result: any) => {
 ...
 */
export function PutSoundFile(id: string, wavBase64: string): $CancellablePromise<void> {
    return $Call.ByID(2418838611, id, wavBase64);
}
 ...
 */
export function RemoveOwnDevice(keyThumbprint: string): $CancellablePromise<void> {
    return $Call.ByID(3065006869, keyThumbprint);
}
 ...
 */
export function ReportNativeNetworkState(report: nativenetwork$0.State): $CancellablePromise<void> {
    return $Call.ByID(2325136475, report);
}
 ...
 */
export function ShutdownBackend(): $CancellablePromise<void> {
    return $Call.ByID(2115861089);
}
...
const $$createType4 = app$0.RemoteArtifact.createFrom;
...
const $$createType13 = browser$0.CompanionSubscription.createFrom;
const $$createType14 = provideraccountapp$0.LoginState.createFrom;
const $$createType15 = appupdate$0.UpdateAvailability.createFrom;
const $$createType16 = app$0.ImportUpdateStatus.createFrom;
const $$createType17 = app$0.ComputerPairingView.createFrom;
const $$createType18 = app$0.ChannelStatePayload.createFrom;
const $$createType19 = store$0.DiffReviewComment.createFrom;
const $$createType20 = store$0.Project.createFrom;
const $$createType21 = store$0.ProposedPlanComment.createFrom;
const $$createType22 = store$0.ThreadGroup.createFrom;
const $$createType23 = transferclient$0.Offer.createFrom;
const $$createType24 = app$0.ProjectDeletionResult.createFrom;
const $$createType25 = settings$0.Settings.createFrom;
const $$createType26 = app$0.PairingStatusView.createFrom;
const $$createType27 = attachedbackends$0.DiscoveredComputer.createFrom;
const $$createType28 = $Create.Array($$createType27);
const $$createType29 = app$0.PasskeySummary.createFrom;
const $$createType30 = app$0.PasskeyStepUpGrant.createFrom;
const $$createType31 = network$0.Settings.createFrom;
const $$createType32 = app$0.GeneratedCommitMessage.createFrom;
const $$createType33 = app$0.AccessOverview.createFrom;
const $$createType34 = app$0.AttachmentThumbnail.createFrom;
const $$createType35 = store$0.ChannelMessage.createFrom;
const $$createType36 = $Create.Array($$createType35);
const $$createType37 = claudeconfig$0.Skill.createFrom;
const $$createType38 = $Create.Array($$createType37);
const $$createType39 = app$0.ClaudeSlashCommands.createFrom;
const $$createType40 = app$0.CodexAccountUsage.createFrom;
const $$createType41 = $Create.Nullable($$createType40);
const $$createType42 = codexskills$0.CwdSkills.createFrom;
const $$createType43 = computerroute$0.Route.createFrom;
const $$createType44 = $Create.Array($$createType43);
const $$createType45 = app$0.ContextSettingsProfile.createFrom;
const $$createType46 = app$0.ConversationMutationState.createFrom;
const $$createType47 = devscan$0.DevServerList.createFrom;
const $$createType48 = app$0.DiffContextResult.createFrom;
const $$createType49 = store$0.DiscussionDefinition.createFrom;
const $$createType50 = app$0.Draft.createFrom;
const $$createType51 = settings$0.EditorSettings.createFrom;
const $$createType52 = git$0.GitStatus.createFrom;
const $$createType53 = keybindings$0.LoadResult.createFrom;
const $$createType54 = app$0.LocalImageData.createFrom;
const $$createType55 = mcpstatus$0.ServerStatus.createFrom;
const $$createType56 = provider$0.ModelCatalog.createFrom;
const $$createType57 = nativenetwork$0.Config.createFrom;
const $$createType58 = app$0.PRCIJobLogResult.createFrom;
const $$createType59 = git$0.CIPipeline.createFrom;
const $$createType60 = git$0.PRDetail.createFrom;
const $$createType61 = app$0.PRMergeConflictsResult.createFrom;
const $$createType62 = app$0.PayloadChunk.createFrom;
const $$createType63 = app$0.PayloadContent.createFrom;
const $$createType64 = app$0.PayloadPreview.createFrom;
const $$createType65 = app$0.WorktreeSetupConfig.createFrom;
const $$createType66 = provider$0.ProviderStatus.createFrom;
const $$createType67 = $Create.Array($$createType66);
const $$createType68 = app$0.PushSenderStatus.createFrom;
const $$createType69 = flushqueue$0.QueuedItem.createFrom;
const $$createType70 = $Create.Array($$createType69);
const $$createType71 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType72 = $Create.Array($$createType71);
const $$createType73 = sshsetup$0.Status.createFrom;
const $$createType74 = app$0.ServiceUpdateStatus.createFrom;
const $$createType75 = soundlib$0.Files.createFrom;
const $$createType76 = spinner$0.Files.createFrom;
const $$createType77 = app$0.TerminalReplay.createFrom;
const $$createType78 = theme$0.Files.createFrom;
const $$createType79 = app$0.ThreadContextUsage.createFrom;
const $$createType80 = app$0.ThreadDefaults.createFrom;
const $$createType81 = store$0.Item.createFrom;
const $$createType82 = app$0.ItemProjectionSource.createFrom;
const $$createType83 = app$0.ThreadLiveState.createFrom;
const $$createType84 = $Create.Array($$createType10);
const $$createType85 = store$0.TurnPreview.createFrom;
const $$createType86 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType87 = $Create.Array($$createType86);
const $$createType88 = store$0.UserMessageTick.createFrom;
const $$createType89 = $Create.Array($$createType88);
const $$createType90 = app$0.WorktreeSetupRunState.createFrom;
const $$createType91 = app$0.TurnEditsDiff.createFrom;
const $$createType92 = $Create.Map($Create.Any, $Create.Any);
const $$createType93 = store$0.UsageBucket.createFrom;
const $$createType94 = $Create.Array($$createType93);
const $$createType95 = app$0.WorkspaceActivity.createFrom;
const $$createType96 = app$0.GitWorkspaceState.createFrom;
const $$createType97 = git$0.GitActionResult.createFrom;
const $$createType98 = app$0.BranchPruneCandidates.createFrom;
const $$createType99 = git$0.GitBranch.createFrom;
const $$createType100 = $Create.Array($$createType99);
const $$createType101 = app$0.WorktreeListItem.createFrom;
const $$createType102 = $Create.Array($$createType101);
const $$createType103 = app$0.BranchPruneResult.createFrom;
const $$createType104 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType105 = app$0.WorktreeStatus.createFrom;
const $$createType106 = $Create.Array($Create.Any);
const $$createType107 = highlightapp$0.Result.createFrom;
const $$createType108 = app$0.ImportRunHandle.createFrom;
const $$createType109 = app$0.ImportUpdateResult.createFrom;
const $$createType110 = app$0.InterruptAndRevertResult.createFrom;
const $$createType111 = app$0.PairingInvite.createFrom;
const $$createType112 = store$0.ActivityRunMembers.createFrom;
const $$createType113 = $Create.Array($$createType7);
const $$createType114 = store$0.Attachment.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = app$0.EditorInfo.createFrom;
const $$createType117 = $Create.Array($$createType116);
const $$createType118 = attachedbackends$0.Attached.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = gitdiff$0.Commit.createFrom;
const $$createType121 = $Create.Array($$createType120);
const $$createType122 = store$0.ChatBarFavorite.createFrom;
const $$createType123 = $Create.Array($$createType122);
const $$createType124 = $Create.Array($$createType19);
const $$createType125 = $Create.Array($$createType49);
const $$createType126 = app$0.ImportScanResult.createFrom;
const $$createType127 = $Create.Array($$createType81);
const $$createType128 = store$0.PagedItems.createFrom;
const $$createType129 = $Create.Array($$createType55);
const $$createType130 = owndevices$0.List.createFrom;
const $$createType131 = git$0.ReviewThread.createFrom;
const $$createType132 = $Create.Array($$createType131);
const $$createType133 = $Create.Array($$createType29);
const $$createType134 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType135 = store$0.ProjectWithCounts.createFrom;
const $$createType136 = $Create.Array($$createType135);
const $$createType137 = $Create.Array($$createType21);
const $$createType138 = app$0.ManagedProviderAccount.createFrom;
const $$createType139 = $Create.Array($$createType138);
const $$createType140 = store$0.Turn.createFrom;
const $$createType141 = $Create.Array($$createType140);
const $$createType142 = appupdate$0.ReleaseSummary.createFrom;
const $$createType143 = $Create.Array($$createType142);
const $$createType144 = app$0.BackgroundWorkInventory.createFrom;
const $$createType145 = terminal$0.SessionSummary.createFrom;
const $$createType146 = $Create.Array($$createType145);
const $$createType147 = app$0.EditDiffList.createFrom;
const $$createType148 = $Create.Array($$createType22);
const $$createType149 = app$0.ThreadLiveActivity.createFrom;
const $$createType150 = $Create.Array($$createType149);
const $$createType151 = app$0.ThreadMCPServer.createFrom;
const $$createType152 = $Create.Array($$createType151);
const $$createType153 = app$0.RemoteJobRecord.createFrom;
const $$createType154 = $Create.Array($$createType153);
const $$createType155 = wsllauncher$0.Distro.createFrom;
const $$createType156 = $Create.Array($$createType155);
const $$createType157 = app$0.ComputerPairingWindow.createFrom;
const $$createType158 = app$0.TerminalHandle.createFrom;
const $$createType159 = provider$0.AccountInfo.createFrom;
const $$createType160 = app$0.ProjectDeletionPreview.createFrom;
const $$createType161 = app$0.ProviderTerminalHandle.createFrom;
const $$createType162 = remotejobs$0.LogChunk.createFrom;
const $$createType163 = app$0.RemoteArtifactChunk.createFrom;
const $$createType164 = app$0.RemoteCommandEnvironment.createFrom;
const $$createType165 = app$0.RemoteCommandProject.createFrom;
const $$createType166 = $Create.Array($$createType165);
const $$createType167 = remotejobs$0.LogSearch.createFrom;
const $$createType168 = app$0.RevertAndResendResult.createFrom;
const $$createType169 = app$0.DeviceRevocationResult.createFrom;
const $$createType170 = store$0.ThreadMessageHit.createFrom;
const $$createType171 = $Create.Array($$createType170);
const $$createType172 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType173 = app$0.CodexReviewStarted.createFrom;
const $$createType174 = app$0.SubmitPRReviewResult.createFrom;
const $$createType175 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType176 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType177 = app$0.MCPAuthInitResult.createFrom;
const $$createType178 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType179 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType180 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType181 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType182 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType183 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType184 = app$0.WorkflowAgentRunView.createFrom;
const $$createType185 = $Create.Array($$createType184);
const $$createType186 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType187 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType188 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType189 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType190 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType191 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType192 = store$0.WorkItem.createFrom;
const $$createType193 = app$0.WorkflowAutomationView.createFrom;
const $$createType194 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType195 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType196 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType197 = engine$0.EngineState.createFrom;
const $$createType198 = app$0.WorkflowItemDetailView.createFrom;
const $$createType199 = app$0.WorkflowRunMapView.createFrom;
const $$createType200 = $Create.Array($$createType193);
const $$createType201 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType202 = $Create.Map($Create.Any, $Create.Any);
const $$createType203 = $Create.Array($$createType192);

...
const $$createType15 = app$0.ComputerPairingView.createFrom;
const $$createType16 = app$0.ChannelStatePayload.createFrom;
const $$createType17 = store$0.DiffReviewComment.createFrom;
const $$createType18 = store$0.Project.createFrom;
const $$createType19 = store$0.ProposedPlanComment.createFrom;
const $$createType20 = store$0.ThreadGroup.createFrom;
const $$createType21 = transferclient$0.Offer.createFrom;
const $$createType22 = app$0.ProjectDeletionResult.createFrom;
const $$createType23 = settings$0.Settings.createFrom;
const $$createType24 = app$0.PairingStatusView.createFrom;
const $$createType25 = attachedbackends$0.DiscoveredComputer.createFrom;
const $$createType26 = $Create.Array($$createType25);
const $$createType27 = app$0.PasskeySummary.createFrom;
const $$createType28 = app$0.PasskeyStepUpGrant.createFrom;
const $$createType29 = network$0.Settings.createFrom;
const $$createType30 = app$0.GeneratedCommitMessage.createFrom;
const $$createType31 = app$0.AccessOverview.createFrom;
const $$createType32 = app$0.AttachmentThumbnail.createFrom;
const $$createType33 = store$0.ChannelMessage.createFrom;
const $$createType34 = $Create.Array($$createType33);
const $$createType35 = claudeconfig$0.Skill.createFrom;
const $$createType36 = $Create.Array($$createType35);
const $$createType37 = app$0.ClaudeSlashCommands.createFrom;
const $$createType38 = app$0.CodexAccountUsage.createFrom;
const $$createType39 = $Create.Nullable($$createType38);
const $$createType40 = codexskills$0.CwdSkills.createFrom;
const $$createType41 = computerroute$0.Route.createFrom;
const $$createType42 = $Create.Array($$createType41);
const $$createType43 = app$0.ContextSettingsProfile.createFrom;
const $$createType44 = devscan$0.DevServerList.createFrom;
const $$createType45 = app$0.DiffContextResult.createFrom;
const $$createType46 = store$0.DiscussionDefinition.createFrom;
const $$createType47 = app$0.Draft.createFrom;
const $$createType48 = settings$0.EditorSettings.createFrom;
const $$createType49 = git$0.GitStatus.createFrom;
const $$createType50 = keybindings$0.LoadResult.createFrom;
const $$createType51 = app$0.LocalImageData.createFrom;
const $$createType52 = mcpstatus$0.ServerStatus.createFrom;
const $$createType53 = provider$0.ModelInfo.createFrom;
const $$createType54 = $Create.Array($$createType53);
const $$createType55 = nativenetwork$0.Config.createFrom;
const $$createType56 = app$0.PRCIJobLogResult.createFrom;
const $$createType57 = git$0.CIPipeline.createFrom;
const $$createType58 = git$0.PRDetail.createFrom;
const $$createType59 = app$0.PRMergeConflictsResult.createFrom;
const $$createType60 = app$0.PayloadChunk.createFrom;
const $$createType61 = app$0.PayloadContent.createFrom;
const $$createType62 = app$0.PayloadPreview.createFrom;
const $$createType63 = app$0.WorktreeSetupConfig.createFrom;
const $$createType64 = provider$0.ProviderStatus.createFrom;
const $$createType65 = $Create.Array($$createType64);
const $$createType66 = app$0.PushSenderStatus.createFrom;
const $$createType67 = flushqueue$0.QueuedItem.createFrom;
const $$createType68 = $Create.Array($$createType67);
const $$createType69 = provider$0.RateLimitsSnapshot.createFrom;
const $$createType70 = $Create.Array($$createType69);
const $$createType71 = sshsetup$0.Status.createFrom;
const $$createType72 = app$0.ServiceUpdateStatus.createFrom;
const $$createType73 = spinner$0.Files.createFrom;
const $$createType74 = app$0.TerminalReplay.createFrom;
const $$createType75 = theme$0.Files.createFrom;
const $$createType76 = app$0.ThreadContextUsage.createFrom;
const $$createType77 = app$0.ThreadDefaults.createFrom;
const $$createType78 = store$0.Item.createFrom;
const $$createType79 = app$0.ItemProjectionSource.createFrom;
const $$createType80 = app$0.ThreadLiveState.createFrom;
const $$createType81 = $Create.Array($$createType8);
const $$createType82 = store$0.TurnPreview.createFrom;
const $$createType83 = store$0.UserMessageHistoryEntry.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = store$0.UserMessageTick.createFrom;
const $$createType86 = $Create.Array($$createType85);
const $$createType87 = app$0.WorktreeSetupRunState.createFrom;
const $$createType88 = app$0.TurnEditsDiff.createFrom;
const $$createType89 = $Create.Map($Create.Any, $Create.Any);
const $$createType90 = store$0.UsageBucket.createFrom;
const $$createType91 = $Create.Array($$createType90);
const $$createType92 = app$0.WorkspaceActivity.createFrom;
const $$createType93 = app$0.GitWorkspaceState.createFrom;
const $$createType94 = git$0.GitActionResult.createFrom;
const $$createType95 = app$0.BranchPruneCandidates.createFrom;
const $$createType96 = git$0.GitBranch.createFrom;
const $$createType97 = $Create.Array($$createType96);
const $$createType98 = app$0.WorktreeListItem.createFrom;
const $$createType99 = $Create.Array($$createType98);
const $$createType100 = app$0.BranchPruneResult.createFrom;
const $$createType101 = app$0.GitStatusSubscriptionResult.createFrom;
const $$createType102 = app$0.WorktreeStatus.createFrom;
const $$createType103 = $Create.Array($Create.Any);
const $$createType104 = highlightapp$0.Result.createFrom;
const $$createType105 = app$0.ImportRunHandle.createFrom;
const $$createType106 = app$0.ImportUpdateResult.createFrom;
const $$createType107 = app$0.InterruptAndRevertResult.createFrom;
const $$createType108 = app$0.PairingInvite.createFrom;
const $$createType109 = $Create.Array($$createType5);
const $$createType110 = store$0.Attachment.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = app$0.EditorInfo.createFrom;
const $$createType113 = $Create.Array($$createType112);
const $$createType114 = attachedbackends$0.Attached.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = gitdiff$0.Commit.createFrom;
const $$createType117 = $Create.Array($$createType116);
const $$createType118 = store$0.ChatBarFavorite.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = $Create.Array($$createType17);
const $$createType121 = $Create.Array($$createType46);
const $$createType122 = app$0.ImportScanResult.createFrom;
const $$createType123 = $Create.Array($$createType78);
const $$createType124 = store$0.PagedItems.createFrom;
const $$createType125 = $Create.Array($$createType52);
const $$createType126 = owndevices$0.List.createFrom;
const $$createType127 = git$0.ReviewThread.createFrom;
const $$createType128 = $Create.Array($$createType127);
const $$createType129 = $Create.Array($$createType27);
const $$createType130 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType131 = store$0.ProjectWithCounts.createFrom;
const $$createType132 = $Create.Array($$createType131);
const $$createType133 = $Create.Array($$createType19);
const $$createType134 = app$0.ManagedProviderAccount.createFrom;
const $$createType135 = $Create.Array($$createType134);
const $$createType136 = store$0.Turn.createFrom;
const $$createType137 = $Create.Array($$createType136);
const $$createType138 = appupdate$0.ReleaseSummary.createFrom;
const $$createType139 = $Create.Array($$createType138);
const $$createType140 = app$0.BackgroundWorkInventory.createFrom;
const $$createType141 = terminal$0.SessionSummary.createFrom;
const $$createType142 = $Create.Array($$createType141);
const $$createType143 = app$0.EditDiffList.createFrom;
const $$createType144 = $Create.Array($$createType20);
const $$createType145 = app$0.ThreadMCPServer.createFrom;
const $$createType146 = $Create.Array($$createType145);
const $$createType147 = wsllauncher$0.Distro.createFrom;
const $$createType148 = $Create.Array($$createType147);
const $$createType149 = app$0.ComputerPairingWindow.createFrom;
const $$createType150 = app$0.TerminalHandle.createFrom;
const $$createType151 = provider$0.AccountInfo.createFrom;
const $$createType152 = app$0.ProjectDeletionPreview.createFrom;
const $$createType153 = app$0.ProviderTerminalHandle.createFrom;
const $$createType154 = app$0.RemoteCommandProject.createFrom;
const $$createType155 = $Create.Array($$createType154);
const $$createType156 = app$0.DeviceRevocationResult.createFrom;
const $$createType157 = store$0.ThreadMessageHit.createFrom;
const $$createType158 = $Create.Array($$createType157);
const $$createType159 = app$0.WorkspaceFileSearchResult.createFrom;
const $$createType160 = app$0.CodexReviewStarted.createFrom;
const $$createType161 = app$0.SubmitPRReviewResult.createFrom;
const $$createType162 = app$0.PRUpdateSubscriptionResult.createFrom;
const $$createType163 = app$0.SyncThreadWindowResponse.createFrom;
const $$createType164 = app$0.MCPAuthInitResult.createFrom;
const $$createType165 = app$0.VerifyEditDiffsResult.createFrom;
const $$createType166 = app$0.WorkflowAgentMemoryResult.createFrom;
const $$createType167 = app$0.WorkflowAgentAmendSeedsResult.createFrom;
const $$createType168 = app$0.WorkflowAgentGuideRunResult.createFrom;
const $$createType169 = app$0.WorkflowAgentRunInspection.createFrom;
const $$createType170 = app$0.WorkflowAgentMemoryLog.createFrom;
const $$createType171 = app$0.WorkflowAgentRunView.createFrom;
const $$createType172 = $Create.Array($$createType171);
const $$createType173 = app$0.WorkflowAgentNarrative.createFrom;
const $$createType174 = app$0.WorkflowAgentRunOutputs.createFrom;
const $$createType175 = app$0.WorkflowAgentScheduleResult.createFrom;
const $$createType176 = app$0.WorkflowAgentNotesResult.createFrom;
const $$createType177 = app$0.WorkflowAgentStartResult.createFrom;
const $$createType178 = app$0.WorkflowAgentWatchResult.createFrom;
const $$createType179 = store$0.WorkItem.createFrom;
const $$createType180 = app$0.WorkflowAutomationView.createFrom;
const $$createType181 = app$0.WorkflowDispositionReceipt.createFrom;
const $$createType182 = app$0.WorkflowDiscardPreview.createFrom;
const $$createType183 = app$0.WorkflowPRReviewComments.createFrom;
const $$createType184 = engine$0.EngineState.createFrom;
const $$createType185 = app$0.WorkflowItemDetailView.createFrom;
const $$createType186 = app$0.WorkflowRunMapView.createFrom;
const $$createType187 = $Create.Array($$createType180);
const $$createType188 = app$0.WorkflowDefinitionCatalog.createFrom;
const $$createType189 = $Create.Map($Create.Any, $Create.Any);
const $$createType190 = $Create.Array($$createType179);

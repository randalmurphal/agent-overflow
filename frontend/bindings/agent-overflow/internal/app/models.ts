...
export class WorkflowAgentPhaseDetail {
    ...
    static createFrom($$source: any = {}): WorkflowAgentPhaseDetail {
        const $$createField7_0 = $$createType97;
        const $$createField10_0 = $$createType8;
...
export class WorkflowAgentRunView {
    ...
    static createFrom($$source: any = {}): WorkflowAgentRunView {
        const $$createField13_0 = $$createType109;
        const $$createField14_0 = $$createType111;
        const $$createField15_0 = $$createType113;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkflowDiscardWorktree {
    ...
    static createFrom($$source: any = {}): WorkflowDiscardWorktree {
        const $$createField7_0 = $$createType8;
        const $$createField9_0 = $$createType127;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkflowRunMapRun {
    ...
    static createFrom($$source: any = {}): WorkflowRunMapRun {
        const $$createField13_0 = $$createType140;
        const $$createField17_0 = $$createType142;
        const $$createField18_0 = $$createType144;
        const $$createField19_0 = $$createType145;
        const $$createField20_0 = $$createType113;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkflowRunMapView {
    ...
    static createFrom($$source: any = {}): WorkflowRunMapView {
        const $$createField1_0 = $$createType147;
        const $$createField2_0 = $$createType149;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkspaceActivity {
    ...
    static createFrom($$source: any = {}): WorkspaceActivity {
        const $$createField2_0 = $$createType151;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkspaceFileSearchResult {
    ...
    static createFrom($$source: any = {}): WorkspaceFileSearchResult {
        const $$createField0_0 = $$createType153;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        if ("files" in $$parsedSource) {
...
export class WorktreeSetupRunState {
    ...
    static createFrom($$source: any = {}): WorktreeSetupRunState {
        const $$createField3_0 = $$createType156;
        const $$createField4_0 = $$createType8;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        if ("steps" in $$parsedSource) {
...
const $$createType67 = UserMessageRevertedEvent.createFrom;
const $$createType68 = $Create.Nullable($$createType67);
const $$createType69 = store$0.DiffReviewPRContext.createFrom;
const $$createType70 = $Create.Nullable($$createType69);
const $$createType71 = store$0.DiffReviewSourceRef.createFrom;
const $$createType72 = $Create.Nullable($$createType71);
const $$createType73 = store$0.PagedItems.createFrom;
const $$createType74 = $Create.Nullable($$createType73);
const $$createType75 = ThreadContextUsageCategory.createFrom;
const $$createType76 = $Create.Array($$createType75);
const $$createType77 = LiveStateActiveTurn.createFrom;
...
const $$createType81 = flushqueue$0.QueuedItem.createFrom;
const $$createType82 = $Create.Array($$createType81);
const $$createType83 = QueueFlushedItem.createFrom;
const $$createType84 = $Create.Array($$createType83);
const $$createType85 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType86 = LiveStateTodo.createFrom;
const $$createType87 = $Create.Nullable($$createType86);
const $$createType88 = ProviderSessionAccountEvent.createFrom;
const $$createType89 = $Create.Nullable($$createType88);
const $$createType90 = $Create.Nullable($$createType79);
const $$createType91 = EditDiffVerifyFile.createFrom;
const $$createType92 = $Create.Array($$createType91);
const $$createType93 = memory$0.Note.createFrom;
const $$createType94 = $Create.Array($$createType93);
const $$createType95 = WorkflowAgentOutputDigest.createFrom;
const $$createType96 = $Create.Array($$createType95);
const $$createType97 = $Create.Map($Create.Any, $Create.Any);
const $$createType98 = WorkflowAgentUnitView.createFrom;
const $$createType99 = $Create.Array($$createType98);
const $$createType100 = WorkflowAgentRunView.createFrom;
const $$createType101 = WorkflowAgentChildRun.createFrom;
const $$createType102 = $Create.Array($$createType101);
const $$createType103 = WorkflowAgentGuidanceEntry.createFrom;
const $$createType104 = $Create.Array($$createType103);
const $$createType105 = WorkflowAgentPhaseDetail.createFrom;
const $$createType106 = $Create.Nullable($$createType105);
const $$createType107 = $Create.Map($Create.Any, $Create.Any);
const $$createType108 = WorkflowAgentFailedUnit.createFrom;
const $$createType109 = $Create.Array($$createType108);
const $$createType110 = WorkflowAgentPhaseAttempt.createFrom;
const $$createType111 = $Create.Array($$createType110);
const $$createType112 = WorkflowAgentRunBudget.createFrom;
const $$createType113 = $Create.Nullable($$createType112);
const $$createType114 = WorkflowAgentTransition.createFrom;
const $$createType115 = $Create.Array($$createType114);
const $$createType116 = WorkflowAgentWatchRunState.createFrom;
const $$createType117 = WorkflowDefinitionListing.createFrom;
const $$createType118 = $Create.Array($$createType117);
const $$createType119 = $Create.Array($Create.Any);
const $$createType120 = WorkflowDefinitionPhase.createFrom;
const $$createType121 = $Create.Array($$createType120);
const $$createType122 = WorkflowDefinitionInput.createFrom;
const $$createType123 = $Create.Array($$createType122);
const $$createType124 = WorkflowDiscardWorktree.createFrom;
...
const $$createType128 = WorkflowDiscardResult.createFrom;
const $$createType129 = $Create.Nullable($$createType128);
const $$createType130 = WorkflowItemView.createFrom;
const $$createType131 = WorkflowItemPhaseView.createFrom;
const $$createType132 = $Create.Array($$createType131);
const $$createType133 = WorkflowItemUnitView.createFrom;
const $$createType134 = $Create.Array($$createType133);
const $$createType135 = WorkflowArtifact.createFrom;
const $$createType136 = $Create.Array($$createType135);
const $$createType137 = store$0.WorkItemUsage.createFrom;
const $$createType138 = WorkflowRunSpend.createFrom;
const $$createType139 = WorkflowRunMapSkeletonPhase.createFrom;
const $$createType140 = $Create.Array($$createType139);
const $$createType141 = WorkflowRunMapPhaseAttempt.createFrom;
const $$createType142 = $Create.Array($$createType141);
const $$createType143 = WorkflowRunMapUnit.createFrom;
const $$createType144 = $Create.Array($$createType143);
const $$createType145 = $Create.Nullable($$createType138);
const $$createType146 = WorkflowRunMapRun.createFrom;
const $$createType147 = $Create.Array($$createType146);
const $$createType148 = WorkflowRunMapRefusal.createFrom;
const $$createType149 = $Create.Nullable($$createType148);
const $$createType150 = BusyThread.createFrom;
const $$createType151 = $Create.Array($$createType150);
const $$createType152 = workspacefiles$0.WorkspaceFile.createFrom;
const $$createType153 = $Create.Array($$createType152);
const $$createType154 = $Create.Array($$createType8);
const $$createType155 = WorktreeSetupStep.createFrom;

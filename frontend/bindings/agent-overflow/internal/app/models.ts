...
export class UserMessageRevertedEvent {
    ...
    static createFrom($$source: any = {}): UserMessageRevertedEvent {
        const $$createField2_0 = $$createType91;
        const $$createField7_0 = $$createType8;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkflowAgentRunOutputs {
    ...
    static createFrom($$source: any = {}): WorkflowAgentRunOutputs {
        const $$createField4_0 = $$createType108;
        const $$createField5_0 = $$createType8;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        if ("outputs" in $$parsedSource) {
...
export class WorkflowAgentRunView {
    ...
    static createFrom($$source: any = {}): WorkflowAgentRunView {
        ...
        const $$createField15_0 = $$createType114;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkflowItemDetailView {
    ...
    static createFrom($$source: any = {}): WorkflowItemDetailView {
        const $$createField0_0 = $$createType131;
        const $$createField1_0 = $$createType8;
        const $$createField2_0 = $$createType8;
        ...
        const $$createField7_0 = $$createType138;
...
export class WorkflowRunMapRun {
    ...
    static createFrom($$source: any = {}): WorkflowRunMapRun {
        const $$createField13_0 = $$createType141;
        const $$createField17_0 = $$createType143;
        const $$createField18_0 = $$createType145;
        const $$createField19_0 = $$createType146;
        const $$createField20_0 = $$createType114;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorkspaceFileSearchResult {
    ...
    static createFrom($$source: any = {}): WorkspaceFileSearchResult {
        const $$createField0_0 = $$createType154;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        if ("files" in $$parsedSource) {
...
export class WorktreeSetupConfig {
    ...
    static createFrom($$source: any = {}): WorktreeSetupConfig {
        const $$createField0_0 = $$createType8;
        const $$createField1_0 = $$createType155;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
...
export class WorktreeSetupRunState {
    ...
    static createFrom($$source: any = {}): WorktreeSetupRunState {
        const $$createField3_0 = $$createType157;
        const $$createField4_0 = $$createType8;
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        if ("steps" in $$parsedSource) {
...
const $$createType74 = store$0.PagedItems.createFrom;
const $$createType75 = $Create.Nullable($$createType74);
const $$createType76 = ThreadContextUsageCategory.createFrom;
const $$createType77 = $Create.Array($$createType76);
const $$createType78 = LiveStateActiveTurn.createFrom;
const $$createType79 = $Create.Nullable($$createType78);
const $$createType80 = store$0.Item.createFrom;
const $$createType81 = $Create.Array($$createType80);
const $$createType82 = flushqueue$0.QueuedItem.createFrom;
const $$createType83 = $Create.Array($$createType82);
const $$createType84 = QueueFlushedItem.createFrom;
const $$createType85 = $Create.Array($$createType84);
const $$createType86 = provider$0.PendingInteractiveRequests.createFrom;
const $$createType87 = LiveStateTodo.createFrom;
const $$createType88 = $Create.Nullable($$createType87);
const $$createType89 = ProviderSessionAccountEvent.createFrom;
const $$createType90 = $Create.Nullable($$createType89);
const $$createType91 = $Create.Nullable($$createType80);
const $$createType92 = EditDiffVerifyFile.createFrom;
const $$createType93 = $Create.Array($$createType92);
const $$createType94 = memory$0.Note.createFrom;
const $$createType95 = $Create.Array($$createType94);
const $$createType96 = WorkflowAgentOutputDigest.createFrom;
const $$createType97 = $Create.Array($$createType96);
const $$createType98 = $Create.Map($Create.Any, $Create.Any);
const $$createType99 = WorkflowAgentUnitView.createFrom;
const $$createType100 = $Create.Array($$createType99);
const $$createType101 = WorkflowAgentRunView.createFrom;
const $$createType102 = WorkflowAgentChildRun.createFrom;
const $$createType103 = $Create.Array($$createType102);
const $$createType104 = WorkflowAgentGuidanceEntry.createFrom;
const $$createType105 = $Create.Array($$createType104);
const $$createType106 = WorkflowAgentPhaseDetail.createFrom;
const $$createType107 = $Create.Nullable($$createType106);
const $$createType108 = $Create.Map($Create.Any, $Create.Any);
const $$createType109 = WorkflowAgentFailedUnit.createFrom;
const $$createType110 = $Create.Array($$createType109);
const $$createType111 = WorkflowAgentPhaseAttempt.createFrom;
const $$createType112 = $Create.Array($$createType111);
const $$createType113 = WorkflowAgentRunBudget.createFrom;
const $$createType114 = $Create.Nullable($$createType113);
const $$createType115 = WorkflowAgentTransition.createFrom;
const $$createType116 = $Create.Array($$createType115);
const $$createType117 = WorkflowAgentWatchRunState.createFrom;
const $$createType118 = WorkflowDefinitionListing.createFrom;
const $$createType119 = $Create.Array($$createType118);
const $$createType120 = $Create.Array($Create.Any);
const $$createType121 = WorkflowDefinitionPhase.createFrom;
const $$createType122 = $Create.Array($$createType121);
const $$createType123 = WorkflowDefinitionInput.createFrom;
const $$createType124 = $Create.Array($$createType123);
const $$createType125 = WorkflowDiscardWorktree.createFrom;
...
const $$createType129 = WorkflowDiscardResult.createFrom;
const $$createType130 = $Create.Nullable($$createType129);
const $$createType131 = WorkflowItemView.createFrom;
const $$createType132 = WorkflowItemPhaseView.createFrom;
const $$createType133 = $Create.Array($$createType132);
const $$createType134 = WorkflowItemUnitView.createFrom;
const $$createType135 = $Create.Array($$createType134);
const $$createType136 = WorkflowArtifact.createFrom;
const $$createType137 = $Create.Array($$createType136);
const $$createType138 = store$0.WorkItemUsage.createFrom;
const $$createType139 = WorkflowRunSpend.createFrom;
const $$createType140 = WorkflowRunMapSkeletonPhase.createFrom;
const $$createType141 = $Create.Array($$createType140);
const $$createType142 = WorkflowRunMapPhaseAttempt.createFrom;
const $$createType143 = $Create.Array($$createType142);
const $$createType144 = WorkflowRunMapUnit.createFrom;
const $$createType145 = $Create.Array($$createType144);
const $$createType146 = $Create.Nullable($$createType139);
const $$createType147 = WorkflowRunMapRun.createFrom;
const $$createType148 = $Create.Array($$createType147);
const $$createType149 = WorkflowRunMapRefusal.createFrom;
const $$createType150 = $Create.Nullable($$createType149);
const $$createType151 = BusyThread.createFrom;
const $$createType152 = $Create.Array($$createType151);
const $$createType153 = workspacefiles$0.WorkspaceFile.createFrom;
const $$createType154 = $Create.Array($$createType153);
const $$createType155 = $Create.Array($$createType8);
const $$createType156 = WorktreeSetupStep.createFrom;

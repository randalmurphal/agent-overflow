...
// and a UI theme first: Nord is one of the few upstreams that publishes a
// four-step ground ramp, so our surface ladder is its Polar Night verbatim.
//
...
export const NORD: BuiltinThemeSpec = {
  ...
  dark: {
    colors: {
      // Polar Night, exactly as published: four grounds for four tiers.
      'surface-0': '#2e3440',
      'surface-1': '#3b4252',
      'surface-2': '#434c5e',
      'surface-3': '#4c566a',

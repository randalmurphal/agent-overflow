 ...
 * machine — the machine picker, Settings → Connect to a computer, the
 * sidebar's row — showing a blank until that backend's manifest resolves,
 * which on an unreachable machine is never. An address is the one thing
 * this client is sure of.
 */

...
export function createThreadDraftPlaceholder(
  ...
  function applyDraftPlaceholderDefaults(
    ...
    const next: Thread = {
      ...
      autoCompactStandardPercent: defaults.autoCompactStandardPercent ?? thread.autoCompactStandardPercent,
      autoCompactExtendedPercent: defaults.autoCompactExtendedPercent ?? thread.autoCompactExtendedPercent,
  ...
  function startDraftPlaceholder(
    ...
    options.setThread({
      ...
      autoCompactStandardPercent: defaults?.autoCompactStandardPercent,
      autoCompactExtendedPercent: defaults?.autoCompactExtendedPercent,
  ...
  async function materializeDraftPlaceholder(): Promise<Thread | null> {
    ...
    const created = (await withBackendTarget(backend, () => CreateThread({
      ...
      autoCompactStandardPercent: current?.autoCompactStandardPercent,
      autoCompactExtendedPercent: current?.autoCompactExtendedPercent,

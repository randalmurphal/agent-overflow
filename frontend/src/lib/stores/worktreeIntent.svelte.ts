...
// Threads with a workspace RPC in flight against their persisted row.
// Reactive so the composer's empty-draft cleanup cannot delete the row
// while the backend is creating and binding its branch or worktree.

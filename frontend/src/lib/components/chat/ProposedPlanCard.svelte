...
<div class="group/proposed-plan relative px-1 py-1" data-testid="proposed-plan-card">
  <div
    class="pointer-events-none absolute right-1 top-1 z-10 opacity-0 transition-opacity duration-150 group-hover/proposed-plan:pointer-events-auto group-hover/proposed-plan:opacity-100 focus-within:pointer-events-auto focus-within:opacity-100 compact:pointer-events-auto compact:opacity-100"

...
const STATIC_FIELDS = [
  ...
  {
    id: 'notifications.sound-turn-complete',
    section: 'notifications',
    heading: 'Sounds',
    label: 'Turn complete cue',
    hint: 'Plays when the agent finishes a turn.',
    keywords: ['sound', 'cue', 'finished', 'done', 'chime'],
    conditional: true,
  },
  {
    id: 'notifications.sound-input-needed',
    section: 'notifications',
    heading: 'Sounds',
    label: 'Approval needed cue',
    hint: 'Plays when the agent is blocked waiting on you.',
    keywords: ['sound', 'cue', 'permission', 'approval', 'input', 'blocked'],
    conditional: true,
  },
  {
    id: 'notifications.sound-attention',
    section: 'notifications',
    heading: 'Sounds',
    label: 'Attention cue',
    hint: 'Plays for errors, a signed-out provider, a workflow that needs you, and update notices.',
    keywords: ['sound', 'cue', 'error', 'failed', 'workflow', 'update', 'signed out'],
    conditional: true,
  },
  {

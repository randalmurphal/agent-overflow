...
const STATIC_FIELDS = [
  ...
  },
  {
    ...
    keywords: ['quiet', 'focus', 'foreground', 'mute', 'while using'],
    conditional: true,
  },
  {
    ...
    keywords: ['quiet', 'visible', 'pane', 'open thread', 'mute'],
    conditional: true,
  },
  {
  ...
  },
  {
    ...
    hint: "Paste the JSON key file for the app's Firebase project. It stays on this machine and is never shown again.",

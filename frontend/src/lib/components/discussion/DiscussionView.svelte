...
{#if isDiscussion}
  <div class="flex flex-col h-full min-h-0">
    <div class="border-b border-border-subtle px-5 py-2 flex items-center gap-2 shrink-0">
      ...
      <span
        class="ml-auto text-[11px] text-fg-muted truncate min-w-0 shrink max-w-[280px] font-mono"
...
{:else}
  <div class="flex items-center justify-center h-full text-[12px] text-fg-subtle">

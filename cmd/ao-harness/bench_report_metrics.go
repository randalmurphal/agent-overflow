...
func benchMetrics() []benchMetric {
	return []benchMetric{
		...
		{Name: "glide.droppedFrames", Unit: "count", LowerIsBetter: true,
			read: frontendMeterMetric("glide", func(f perfFrontendSummary) float64 { return float64(f.Glide.DroppedFrames) })},
		{Name: "glide.maxHoleFrames", Unit: "count", LowerIsBetter: true,
			read: frontendMeterMetric("glide", func(f perfFrontendSummary) float64 { return float64(f.Glide.MaxHoleFrames) })},
		{Name: "glide.lateTicks", Unit: "count", LowerIsBetter: true,
			read: frontendMeterMetric("glide", func(f perfFrontendSummary) float64 { return float64(f.Glide.LateTicks) })},
		{Name: "glide.unevenWrites", Unit: "count", LowerIsBetter: true,
			read: frontendMeterMetric("glide", func(f perfFrontendSummary) float64 { return float64(f.Glide.UnevenWrites) })},
		{Name: "glide.stepJumps", Unit: "count", LowerIsBetter: true,
			read: frontendMeterMetric("glide", func(f perfFrontendSummary) float64 { return float64(f.Glide.StepJumps) })},
		{Name: "glide.fallbackTicks", Unit: "count", LowerIsBetter: true,
			read: frontendMeterMetric("glide", func(f perfFrontendSummary) float64 { return float64(f.Glide.FallbackTicks) })},

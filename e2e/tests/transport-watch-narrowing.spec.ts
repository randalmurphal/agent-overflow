...
// transport would be production code that exists for one spec, and the
// property under test is precisely what goes over the wire.
 ...
 */
async function recordWire(page: Page): Promise<void> {
...
function readWire(page: Page): Promise<WireLog> {
...
function watchedNow(wire: WireLog): string[] | null {

...
| `make e2e-android` | the compact Playwright project inside a running emulator's WebView, where the native seams are real. Not a blocking gate: with no device attached it prints how to start one and exits clean. |

...
| [`app-update.md`](specs/app-update.md) | In-app updates on macOS, Linux and Windows: database snapshot, trial boot, commit or rollback, and recovery after a crash. Design; not implemented. |

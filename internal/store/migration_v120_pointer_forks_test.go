...
func TestMigrationV120PointerForks(t *testing.T) {
	...
	for _, object := range []string{
		...
		"idx_items_attachment_refs", "idx_import_history_items_attachment_refs",
		"trg_threads_fork_source_delete", "trg_items_fork_position", "trg_items_fork_position_update",
		"trg_items_fork_snapshot", "trg_items_fork_snapshot_move", "trg_items_fork_reader_stamp", "timeline_items", "timeline_payloads", "timeline_payload_chunks",

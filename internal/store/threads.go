...
// threadColumnsNotWrittenByUpdateThread below, which names each one and why.
...
//
// This map is consulted by nothing at runtime. That is deliberate: the SQL is
// the behavior, and a second list the writer derived from would only be able

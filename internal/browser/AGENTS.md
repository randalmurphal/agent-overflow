...
- The pane rect arrives in top-left CSS coordinates and is flipped against the
  content view's own `isFlipped`, never assumed. AppKit needs no reparenting
  surgery: a second subview joins Wails' content view directly.

...
void ao_wkv_host_present(void *view, int x, int y, int width, int height) {
  @autoreleasepool {
    ...
    CGFloat originY = [ao_host isFlipped] ? (CGFloat)y
                                          : bounds.size.height - (CGFloat)(y + height);
    [v setFrame:NSMakeRect((CGFloat)x, originY, (CGFloat)width, (CGFloat)height)];
    [v setHidden:NO];
    ao_presented = v;
  }
}

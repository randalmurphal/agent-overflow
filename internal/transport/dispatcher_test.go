...
func (p *privilegedApp) WriteWorkspaceFile() string             { return "ok" }
...
func (p *privilegedApp) GetEditDiffContextLines() string        { return "ok" }
func (p *privilegedApp) VerifyEditDiffs() string                { return "ok" }
func (p *privilegedApp) HighlightPatchWithContext() string      { return "ok" }
func (p *privilegedApp) HighlightEditPatchWithContext() string  { return "ok" }
...
func (p *privilegedApp) BrowserHostReport() string         { return "ok" }

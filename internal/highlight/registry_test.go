...
func TestLangFromPath(t *testing.T) {
	cases := map[string]Lang{
		...
		"Main.java":               LangJava,
		"Cargo.toml":              LangTOML,
		`C:\repo\pyproject.TOML`:  LangTOML,
		"settings.ini":            LangINI,
		".editorconfig":           LangINI,
		`C:\Users\dev\.gitconfig`: LangINI,
		"main.tf":                 LangHCL,
		"dev.tfvars":              LangHCL,
		"terraform.tfvars.json":   LangJSON,
		"stack.hcl":               LangHCL,
		"Makefile":                LangMake,
		"build/makefile":          LangMake,
		"GNUmakefile":             LangMake,
		`C:\repo\rules.mk`:        LangMake,
		"old.mak":                 LangMake,
		"Dockerfile":              LangDockerfile,
		"Dockerfile.dev":          LangDockerfile,
		`C:\repo\dev.Dockerfile`:  LangDockerfile,
		"Containerfile":           LangDockerfile,
		"Containerfile.dev":       LangDockerfile,
		"dev.Containerfile":       LangDockerfile,
		"notDockerfile":           LangPlaintext,
		"document.xml":            LangXML,
		"project.csproj":          LangXML,
		"schema.xsd":              LangXML,
		"style.xslt":              LangXML,
		"icon.svg":                LangXML,
		"Info.plist":              LangXML,
		"Directory.Build.props":   LangXML,
		"resources.resx":          LangXML,
		"script.ps1":              LangPowerShell,
		"module.psm1":             LangPowerShell,
		"module.psd1":             LangPowerShell,
		"settings.conf":           LangPlaintext,
		"noext":                   LangPlaintext,

...
// (`internal/workflowapp/discard_apply.go`): a discard is the human saying the work is
...
func (a *App) cleanUpProjectWorkflowWork(
	projectID string, footprint projectapp.WorkflowFootprint,
...
// running on.
func (a *App) stopProjectWorkflowRuns(footprint projectapp.WorkflowFootprint) error {
	var errs []error
...
func (a *App) refreshWorkflowSchedule() error {
	return a.workflowApplication().RefreshScheduler()
}
